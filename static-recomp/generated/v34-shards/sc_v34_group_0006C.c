...
int sc_v34_group_0006C(SCV11Runtime *r,uint32_t address,uint8_t m,uint8_t x,uint8_t e){
  ...
  case 0x01B377u:
    if(m==0u&&x==0u&&e==0u){ /* AD 01 02 Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B377u,3u);r->open_bus=0x02u;
  ...
  case 0x01B37Au:
    if(m==0u&&x==0u&&e==0u){ /* D0 01 Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B37Au,2u);r->open_bus=0x01u;
  ...
  case 0x01B37Du:
    if(m==0u&&x==0u&&e==0u){ /* AE F9 01 Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B37Du,3u);r->open_bus=0x01u;
  ...
  case 0x01B380u:
    if(m==0u&&x==0u&&e==0u){ /* BF C0 80 01 Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B380u,4u);r->open_bus=0x01u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xB384u;
  ...
  case 0x01B384u:
    if(m==0u&&x==0u&&e==0u){ /* 29 FF 00 Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B384u,3u);r->open_bus=0x00u;
  ...
  case 0x01B387u:
    if(m==0u&&x==0u&&e==0u){ /* 85 79 Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B387u,2u);r->open_bus=0x79u;
  ...
  case 0x01B389u:
    if(m==0u&&x==0u&&e==0u){ /* AD EB 01 Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B389u,3u);r->open_bus=0x01u;
  ...
  case 0x01B38Cu:
    if(m==0u&&x==0u&&e==0u){ /* 4A Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B38Cu,1u);r->open_bus=0x4Au;
  ...
  case 0x01B38Du:
    if(m==0u&&x==0u&&e==0u){ /* 4A Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B38Du,1u);r->open_bus=0x4Au;
  ...
  case 0x01B38Eu:
    if(m==0u&&x==0u&&e==0u){ /* 4A Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B38Eu,1u);r->open_bus=0x4Au;
  ...
  case 0x01B38Fu:
    if(m==0u&&x==0u&&e==0u){ /* 18 Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B38Fu,1u);r->open_bus=0x18u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xB390u;
  ...
  case 0x01B390u:
    if(m==0u&&x==0u&&e==0u){ /* 6D BD 01 Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B390u,3u);r->open_bus=0x01u;
  ...
  case 0x01B393u:
    if(m==0u&&x==0u&&e==0u){ /* 10 0F Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B393u,2u);r->open_bus=0x0Fu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xB395u;
  ...
  case 0x01B3A4u:
    if(m==0u&&x==0u&&e==0u){ /* 18 Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B3A4u,1u);r->open_bus=0x18u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xB3A5u;
      c->p=(uint8_t)(c->p&~SC_FLAG_C);sc_v11_scheduler_idle_or_read(r);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x01B3A5u:
    if(m==0u&&x==0u&&e==0u){ /* 65 79 Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B3A5u,2u);r->open_bus=0x79u;
  ...
  case 0x01B3A7u:
    if(m==0u&&x==0u&&e==0u){ /* C9 78 00 Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B3A7u,3u);r->open_bus=0x00u;
  ...
  case 0x01B3AAu:
    if(m==0u&&x==0u&&e==0u){ /* F0 0A Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B3AAu,2u);r->open_bus=0x0Au;
  ...
  case 0x01B3ACu:
    if(m==0u&&x==0u&&e==0u){ /* 90 08 Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B3ACu,2u);r->open_bus=0x08u;
  ...
  case 0x01B3B6u:
    if(m==0u&&x==0u&&e==0u){ /* AD ED 01 Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B3B6u,3u);r->open_bus=0x01u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xB3B9u;
  ...
  case 0x01B3B9u:
    if(m==0u&&x==0u&&e==0u){ /* 4A Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B3B9u,1u);r->open_bus=0x4Au;
  ...
  case 0x01B3BAu:
    if(m==0u&&x==0u&&e==0u){ /* 4A Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B3BAu,1u);r->open_bus=0x4Au;
  ...
  case 0x01B3BBu:
    if(m==0u&&x==0u&&e==0u){ /* 4A Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B3BBu,1u);r->open_bus=0x4Au;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xB3BCu;
      sc_v11_op_shift_accumulator(r,16u,1u);sc_v11_scheduler_idle_or_read(r);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x01B3BCu:
    if(m==0u&&x==0u&&e==0u){ /* 18 Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B3BCu,1u);r->open_bus=0x18u;
  ...
  case 0x01B3BDu:
    if(m==0u&&x==0u&&e==0u){ /* 6D BF 01 Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B3BDu,3u);r->open_bus=0x01u;
  ...
  case 0x01B3C0u:
    if(m==0u&&x==0u&&e==0u){ /* 10 0E Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B3C0u,2u);r->open_bus=0x0Eu;
  ...
  case 0x01B3D0u:
    if(m==0u&&x==0u&&e==0u){ /* 18 Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B3D0u,1u);r->open_bus=0x18u;
  ...
  case 0x01B3D1u:
    if(m==0u&&x==0u&&e==0u){ /* 65 79 Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B3D1u,2u);r->open_bus=0x79u;
  ...
  case 0x01B3D3u:
    if(m==0u&&x==0u&&e==0u){ /* C9 64 00 Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B3D3u,3u);r->open_bus=0x00u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xB3D6u;
  ...
  case 0x01B3D6u:
    if(m==0u&&x==0u&&e==0u){ /* F0 0A Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B3D6u,2u);r->open_bus=0x0Au;
  ...
  case 0x01B3D8u:
    if(m==0u&&x==0u&&e==0u){ /* 90 08 Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B3D8u,2u);r->open_bus=0x08u;
  ...
  case 0x01B3E2u:
    if(m==0u&&x==0u&&e==0u){ /* 60 Mesen corrected gameplay frame 2649; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x01B3E2u,1u);r->open_bus=0x60u;
