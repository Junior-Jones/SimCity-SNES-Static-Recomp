...
int sc_v34_group_000A2(SCV11Runtime *r,uint32_t address,uint8_t m,uint8_t x,uint8_t e){
  ...
  case 0x02899Du:
    if(m==0u&&x==0u&&e==0u){ /* 9C 63 0D Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x02899Du,3u);r->open_bus=0x0Du;
  ...
  case 0x0289A0u:
    if(m==0u&&x==0u&&e==0u){ /* 9C 61 0D Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x0289A0u,3u);r->open_bus=0x0Du;
  ...
  case 0x0289A6u:
    if(m==0u&&x==0u&&e==0u){ /* A0 00 00 Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x0289A6u,3u);r->open_bus=0x00u;
  ...
  case 0x0289A9u:
    if(m==0u&&x==0u&&e==0u){ /* 5A Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x0289A9u,1u);r->open_bus=0x5Au;
  ...
  case 0x0289AAu:
    if(m==0u&&x==0u&&e==0u){ /* E2 20 Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x0289AAu,2u);r->open_bus=0x20u;
  ...
  case 0x0289ACu:
    if(m==1u&&x==0u&&e==0u){ /* 8B Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x0289ACu,1u);r->open_bus=0x8Bu;
  ...
  case 0x0289ADu:
    if(m==1u&&x==0u&&e==0u){ /* A9 02 Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x0289ADu,2u);r->open_bus=0x02u;
  ...
  case 0x0289AFu:
    if(m==1u&&x==0u&&e==0u){ /* 48 Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x0289AFu,1u);r->open_bus=0x48u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x89B0u;
  ...
  case 0x0289B0u:
    if(m==1u&&x==0u&&e==0u){ /* AB Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x0289B0u,1u);r->open_bus=0xABu;
  ...
  case 0x0289B1u:
    if(m==1u&&x==0u&&e==0u){ /* 20 34 8B Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x0289B1u,3u);r->open_bus=0x8Bu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x89B4u;
  ...
  case 0x0289C8u:
    if(m==0u&&x==0u&&e==0u){ /* C0 08 00 Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x0289C8u,3u);r->open_bus=0x00u;
  ...
  case 0x0289CBu:
    if(m==0u&&x==0u&&e==0u){ /* D0 DC Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x0289CBu,2u);r->open_bus=0xDCu;
  ...
  case 0x0289CDu:
    if(m==0u&&x==0u&&e==0u){ /* 20 9D 90 Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x0289CDu,3u);r->open_bus=0x90u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x89D0u;
  ...
  case 0x028B34u:
    if(m==1u&&x==0u&&e==0u){ /* C2 30 Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x028B34u,2u);r->open_bus=0x30u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x8B36u;
      sc_v11_unpack_p(c,(uint8_t)(c->p&((uint8_t)~0x30u)));sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x028B36u:
    if(m==0u&&x==0u&&e==0u){ /* AE 63 0D Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x028B36u,3u);r->open_bus=0x0Du;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x8B39u;
  ...
  case 0x028B39u:
    if(m==0u&&x==0u&&e==0u){ /* BF 00 02 7F Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x028B39u,4u);r->open_bus=0x7Fu;
  ...
  case 0x028B3Du:
    if(m==0u&&x==0u&&e==0u){ /* 29 FF 03 Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x028B3Du,3u);r->open_bus=0x03u;
  ...
  case 0x028B40u:
    if(m==0u&&x==0u&&e==0u){ /* AA Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x028B40u,1u);r->open_bus=0xAAu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x8B41u;
  ...
  case 0x028B41u:
    if(m==0u&&x==0u&&e==0u){ /* E0 30 00 Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x028B41u,3u);r->open_bus=0x00u;
  ...
  case 0x028B44u:
    if(m==0u&&x==0u&&e==0u){ /* 90 1F Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x028B44u,2u);r->open_bus=0x1Fu;
  ...
  case 0x028B65u:
    if(m==0u&&x==0u&&e==0u){ /* AA Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x028B65u,1u);r->open_bus=0xAAu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x8B66u;
      c->x=c->a;sc_v11_set_nz16(c,c->x);sc_v11_scheduler_idle_or_read(r);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x028B66u:
    if(m==0u&&x==0u&&e==0u){ /* E0 14 00 Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x028B66u,3u);r->open_bus=0x00u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x8B69u;
  ...
  case 0x028B69u:
    if(m==0u&&x==0u&&e==0u){ /* 90 28 Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x028B69u,2u);r->open_bus=0x28u;
  ...
  case 0x028B6Bu:
    if(m==0u&&x==0u&&e==0u){ /* E0 26 00 Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x028B6Bu,3u);r->open_bus=0x00u;
  ...
  case 0x028B6Eu:
    if(m==0u&&x==0u&&e==0u){ /* B0 23 Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x028B6Eu,2u);r->open_bus=0x23u;
  ...
  case 0x028B70u:
    if(m==0u&&x==0u&&e==0u){ /* A5 3E Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x028B70u,2u);r->open_bus=0x3Eu;
  ...
  case 0x028B72u:
    if(m==0u&&x==0u&&e==0u){ /* C9 03 00 Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x028B72u,3u);r->open_bus=0x00u;
  ...
  case 0x028B75u:
    if(m==0u&&x==0u&&e==0u){ /* D0 1C Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x028B75u,2u);r->open_bus=0x1Cu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x8B77u;
  ...
  case 0x028B93u:
    if(m==0u&&x==0u&&e==0u){ /* BD 8E 94 Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x028B93u,3u);r->open_bus=0x94u;
  ...
  case 0x028B96u:
    if(m==0u&&x==0u&&e==0u){ /* 60 Mesen corrected gameplay frame 1575; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x028B96u,1u);r->open_bus=0x60u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x8B97u;
      {uint16_t q;sc_v11_scheduler_internal_cycle(r,2u);q=sc_v11_pop16(r);sc_v11_scheduler_internal_cycle(r,1u);c->pc=(uint16_t)(q+1u);}
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
