...
int sc_v34_group_000F0(SCV11Runtime *r,uint32_t address,uint8_t m,uint8_t x,uint8_t e){
  ...
  case 0x03C0AFu:
    if(m==0u&&x==0u&&e==0u){ /* AD 95 03 Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C0AFu,3u);r->open_bus=0x03u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xC0B2u;
  ...
  case 0x03C0B2u:
    if(m==0u&&x==0u&&e==0u){ /* 0D D7 00 Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C0B2u,3u);r->open_bus=0x00u;
  ...
  case 0x03C0B5u:
    if(m==0u&&x==0u&&e==0u){ /* D0 42 Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C0B5u,2u);r->open_bus=0x42u;
  ...
  case 0x03C0B7u:
    if(m==0u&&x==0u&&e==0u){ /* 20 FA C0 Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C0B7u,3u);r->open_bus=0xC0u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xC0BAu;
  ...
  case 0x03C0CFu:
    if(m==0u&&x==0u&&e==0u){ /* 20 31 C1 Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C0CFu,3u);r->open_bus=0xC1u;
  ...
  case 0x03C0FAu:
    if(m==0u&&x==0u&&e==0u){ /* AC A5 0C Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C0FAu,3u);r->open_bus=0x0Cu;
  ...
  case 0x03C0FDu:
    if(m==0u&&x==0u&&e==0u){ /* 20 1A C1 Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C0FDu,3u);r->open_bus=0xC1u;
  ...
  case 0x03C11Au:
    if(m==0u&&x==0u&&e==0u){ /* E2 20 Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C11Au,2u);r->open_bus=0x20u;
  ...
  case 0x03C11Cu:
    if(m==1u&&x==0u&&e==0u){ /* AD A5 0B Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C11Cu,3u);r->open_bus=0x0Bu;
  ...
  case 0x03C11Fu:
    if(m==1u&&x==0u&&e==0u){ /* D9 95 C0 Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C11Fu,3u);r->open_bus=0xC0u;
  ...
  case 0x03C122u:
    if(m==1u&&x==0u&&e==0u){ /* AD A6 0B Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C122u,3u);r->open_bus=0x0Bu;
  ...
  case 0x03C125u:
    if(m==1u&&x==0u&&e==0u){ /* F9 9D C0 Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C125u,3u);r->open_bus=0xC0u;
  ...
  case 0x03C128u:
    if(m==1u&&x==0u&&e==0u){ /* AD A7 0B Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C128u,3u);r->open_bus=0x0Bu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xC12Bu;
  ...
  case 0x03C12Bu:
    if(m==1u&&x==0u&&e==0u){ /* F9 A5 C0 Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C12Bu,3u);r->open_bus=0xC0u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xC12Eu;
  ...
  case 0x03C12Eu:
    if(m==1u&&x==0u&&e==0u){ /* C2 20 Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C12Eu,2u);r->open_bus=0x20u;
  ...
  case 0x03C130u:
    if(m==0u&&x==0u&&e==0u){ /* 60 Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C130u,1u);r->open_bus=0x60u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xC131u;
      {uint16_t q;sc_v11_scheduler_internal_cycle(r,2u);q=sc_v11_pop16(r);sc_v11_scheduler_internal_cycle(r,1u);c->pc=(uint16_t)(q+1u);}
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03C131u:
    if(m==0u&&x==0u&&e==0u){ /* AD A7 0C Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C131u,3u);r->open_bus=0x0Cu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xC134u;
  ...
  case 0x03C134u:
    if(m==0u&&x==0u&&e==0u){ /* D0 15 Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C134u,2u);r->open_bus=0x15u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xC136u;
  ...
  case 0x03C136u:
    if(m==0u&&x==0u&&e==0u){ /* AD A5 0C Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C136u,3u);r->open_bus=0x0Cu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xC139u;
  ...
  case 0x03C139u:
    if(m==0u&&x==0u&&e==0u){ /* F0 10 Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C139u,2u);r->open_bus=0x10u;
  ...
  case 0x03C14Bu:
    if(m==0u&&x==0u&&e==0u){ /* 60 Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C14Bu,1u);r->open_bus=0x60u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xC14Cu;
      {uint16_t q;sc_v11_scheduler_internal_cycle(r,2u);q=sc_v11_pop16(r);sc_v11_scheduler_internal_cycle(r,1u);c->pc=(uint16_t)(q+1u);}
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03C3D8u:
    if(m==0u&&x==0u&&e==0u){ /* C9 01 00 Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C3D8u,3u);r->open_bus=0x00u;
  ...
  case 0x03C3DBu:
    if(m==0u&&x==0u&&e==0u){ /* F0 01 Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C3DBu,2u);r->open_bus=0x01u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xC3DDu;
  ...
  case 0x03C3DDu:
    if(m==0u&&x==0u&&e==0u){ /* C8 Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C3DDu,1u);r->open_bus=0xC8u;
  ...
  case 0x03C3DEu:
    if(m==0u&&x==0u&&e==0u){ /* 20 1A C1 Mesen corrected gameplay frame 3387; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03C3DEu,3u);r->open_bus=0xC1u;
