...
int sc_v34_group_00030(SCV11Runtime *r,uint32_t address,uint8_t m,uint8_t x,uint8_t e){
  ...
  case 0x00C0F9u:
    if(m==1u&&x==0u&&e==0u){ /* A9 E0 Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C0F9u,2u);r->open_bus=0xE0u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xC0FBu;
  ...
  case 0x00C0FBu:
    if(m==1u&&x==0u&&e==0u){ /* 8F B5 21 7E Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C0FBu,4u);r->open_bus=0x7Eu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xC0FFu;
  ...
  case 0x00C0FFu:
    if(m==1u&&x==0u&&e==0u){ /* 8F B9 21 7E Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C0FFu,4u);r->open_bus=0x7Eu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xC103u;
  ...
  case 0x00C103u:
    if(m==1u&&x==0u&&e==0u){ /* 8F BD 21 7E Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C103u,4u);r->open_bus=0x7Eu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xC107u;
  ...
  case 0x00C107u:
    if(m==1u&&x==0u&&e==0u){ /* 8F C1 21 7E Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C107u,4u);r->open_bus=0x7Eu;
  ...
  case 0x00C10Bu:
    if(m==1u&&x==0u&&e==0u){ /* 8F D5 21 7E Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C10Bu,4u);r->open_bus=0x7Eu;
  ...
  case 0x00C10Fu:
    if(m==1u&&x==0u&&e==0u){ /* 8F D9 21 7E Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C10Fu,4u);r->open_bus=0x7Eu;
  ...
  case 0x00C113u:
    if(m==1u&&x==0u&&e==0u){ /* 8F DD 21 7E Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C113u,4u);r->open_bus=0x7Eu;
  ...
  case 0x00C117u:
    if(m==1u&&x==0u&&e==0u){ /* 8F E1 21 7E Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C117u,4u);r->open_bus=0x7Eu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xC11Bu;
  ...
  case 0x00C11Bu:
    if(m==1u&&x==0u&&e==0u){ /* 8F E5 21 7E Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C11Bu,4u);r->open_bus=0x7Eu;
  ...
  case 0x00C11Fu:
    if(m==1u&&x==0u&&e==0u){ /* 8F E9 21 7E Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C11Fu,4u);r->open_bus=0x7Eu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xC123u;
  ...
  case 0x00C123u:
    if(m==1u&&x==0u&&e==0u){ /* 8F ED 21 7E Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C123u,4u);r->open_bus=0x7Eu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xC127u;
  ...
  case 0x00C127u:
    if(m==1u&&x==0u&&e==0u){ /* E2 20 Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C127u,2u);r->open_bus=0x20u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xC129u;
      sc_v11_unpack_p(c,(uint8_t)(c->p|0x20u));sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x00C129u:
    if(m==1u&&x==0u&&e==0u){ /* AF 1B 22 7E Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C129u,4u);r->open_bus=0x7Eu;
  ...
  case 0x00C12Du:
    if(m==1u&&x==0u&&e==0u){ /* 29 03 Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C12Du,2u);r->open_bus=0x03u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xC12Fu;
  ...
  case 0x00C12Fu:
    if(m==1u&&x==0u&&e==0u){ /* 09 54 Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C12Fu,2u);r->open_bus=0x54u;
  ...
  case 0x00C131u:
    if(m==1u&&x==0u&&e==0u){ /* 8F 1B 22 7E Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C131u,4u);r->open_bus=0x7Eu;
  ...
  case 0x00C135u:
    if(m==1u&&x==0u&&e==0u){ /* AF 1C 22 7E Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C135u,4u);r->open_bus=0x7Eu;
  ...
  case 0x00C139u:
    if(m==1u&&x==0u&&e==0u){ /* 29 FC Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C139u,2u);r->open_bus=0xFCu;
  ...
  case 0x00C13Bu:
    if(m==1u&&x==0u&&e==0u){ /* 09 01 Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C13Bu,2u);r->open_bus=0x01u;
  ...
  case 0x00C13Du:
    if(m==1u&&x==0u&&e==0u){ /* 8F 1C 22 7E Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C13Du,4u);r->open_bus=0x7Eu;
  ...
  case 0x00C141u:
    if(m==1u&&x==0u&&e==0u){ /* AF 1D 22 7E Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C141u,4u);r->open_bus=0x7Eu;
  ...
  case 0x00C145u:
    if(m==1u&&x==0u&&e==0u){ /* 29 03 Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C145u,2u);r->open_bus=0x03u;
  ...
  case 0x00C147u:
    if(m==1u&&x==0u&&e==0u){ /* 09 54 Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C147u,2u);r->open_bus=0x54u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xC149u;
      sc_v11_op_ora(r,0x0054u,8u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x00C149u:
    if(m==1u&&x==0u&&e==0u){ /* 8F 1D 22 7E Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C149u,4u);r->open_bus=0x7Eu;
  ...
  case 0x00C14Du:
    if(m==1u&&x==0u&&e==0u){ /* A9 55 Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C14Du,2u);r->open_bus=0x55u;
  ...
  case 0x00C14Fu:
    if(m==1u&&x==0u&&e==0u){ /* 8F 1E 22 7E Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C14Fu,4u);r->open_bus=0x7Eu;
  ...
  case 0x00C153u:
    if(m==1u&&x==0u&&e==0u){ /* 60 Mesen corrected gameplay frame 2551; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x00C153u,1u);r->open_bus=0x60u;
