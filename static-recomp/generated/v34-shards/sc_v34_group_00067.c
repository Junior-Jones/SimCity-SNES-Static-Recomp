...
int sc_v34_group_00067(SCV11Runtime *r,uint32_t address,uint8_t m,uint8_t x,uint8_t e){
  ...
  case 0x019C9Du:
    if(m==0u&&x==0u&&e==0u){ /* AD 81 03 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019C9Du,3u);r->open_bus=0x03u;
  ...
  case 0x019CA0u:
    if(m==0u&&x==0u&&e==0u){ /* 0A Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CA0u,1u);r->open_bus=0x0Au;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x9CA1u;
  ...
  case 0x019CA1u:
    if(m==0u&&x==0u&&e==0u){ /* AA Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CA1u,1u);r->open_bus=0xAAu;
  ...
  case 0x019CA2u:
    if(m==0u&&x==0u&&e==0u){ /* BF E3 97 01 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CA2u,4u);r->open_bus=0x01u;
  ...
  case 0x019CA6u:
    if(m==0u&&x==0u&&e==0u){ /* 85 79 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CA6u,2u);r->open_bus=0x79u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x9CA8u;
  ...
  case 0x019CA8u:
    if(m==0u&&x==0u&&e==0u){ /* A9 10 06 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CA8u,3u);r->open_bus=0x06u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x9CABu;
  ...
  case 0x019CABu:
    if(m==0u&&x==0u&&e==0u){ /* 85 7C Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CABu,2u);r->open_bus=0x7Cu;
  ...
  case 0x019CADu:
    if(m==0u&&x==0u&&e==0u){ /* AD 81 03 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CADu,3u);r->open_bus=0x03u;
  ...
  case 0x019CB0u:
    if(m==0u&&x==0u&&e==0u){ /* AA Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CB0u,1u);r->open_bus=0xAAu;
  ...
  case 0x019CB1u:
    if(m==0u&&x==0u&&e==0u){ /* BF FB 94 01 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CB1u,4u);r->open_bus=0x01u;
  ...
  case 0x019CB5u:
    if(m==0u&&x==0u&&e==0u){ /* 29 FF 00 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CB5u,3u);r->open_bus=0x00u;
  ...
  case 0x019CB8u:
    if(m==0u&&x==0u&&e==0u){ /* AA Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CB8u,1u);r->open_bus=0xAAu;
  ...
  case 0x019CB9u:
    if(m==0u&&x==0u&&e==0u){ /* BF 8C 97 01 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CB9u,4u);r->open_bus=0x01u;
  ...
  case 0x019CBDu:
    if(m==0u&&x==0u&&e==0u){ /* 29 FF 00 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CBDu,3u);r->open_bus=0x00u;
  ...
  case 0x019CC0u:
    if(m==0u&&x==0u&&e==0u){ /* 38 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CC0u,1u);r->open_bus=0x38u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x9CC1u;
  ...
  case 0x019CC1u:
    if(m==0u&&x==0u&&e==0u){ /* E9 02 00 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CC1u,3u);r->open_bus=0x00u;
  ...
  case 0x019CC4u:
    if(m==0u&&x==0u&&e==0u){ /* 85 7F Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CC4u,2u);r->open_bus=0x7Fu;
  ...
  case 0x019CC6u:
    if(m==0u&&x==0u&&e==0u){ /* A9 02 00 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CC6u,3u);r->open_bus=0x00u;
  ...
  case 0x019CC9u:
    if(m==0u&&x==0u&&e==0u){ /* 85 82 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CC9u,2u);r->open_bus=0x82u;
  ...
  case 0x019CCBu:
    if(m==0u&&x==0u&&e==0u){ /* A6 79 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CCBu,2u);r->open_bus=0x79u;
  ...
  case 0x019CCDu:
    if(m==0u&&x==0u&&e==0u){ /* A5 7F Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CCDu,2u);r->open_bus=0x7Fu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x9CCFu;
  ...
  case 0x019CCFu:
    if(m==0u&&x==0u&&e==0u){ /* 48 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CCFu,1u);r->open_bus=0x48u;
  ...
  case 0x019CD0u:
    if(m==0u&&x==0u&&e==0u){ /* A4 7C Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CD0u,2u);r->open_bus=0x7Cu;
  ...
  case 0x019CD2u:
    if(m==0u&&x==0u&&e==0u){ /* BF 00 00 01 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CD2u,4u);r->open_bus=0x01u;
  ...
  case 0x019CD6u:
    if(m==0u&&x==0u&&e==0u){ /* 29 FF 00 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CD6u,3u);r->open_bus=0x00u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x9CD9u;
      sc_v11_op_and(r,0x00FFu,16u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x019CD9u:
    if(m==0u&&x==0u&&e==0u){ /* 09 00 2C Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CD9u,3u);r->open_bus=0x2Cu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x9CDCu;
  ...
  case 0x019CDCu:
    if(m==0u&&x==0u&&e==0u){ /* DA Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CDCu,1u);r->open_bus=0xDAu;
  ...
  case 0x019CDDu:
    if(m==0u&&x==0u&&e==0u){ /* BB Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CDDu,1u);r->open_bus=0xBBu;
  ...
  case 0x019CDEu:
    if(m==0u&&x==0u&&e==0u){ /* 9F 40 38 7E Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CDEu,4u);r->open_bus=0x7Eu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x9CE2u;
  ...
  case 0x019CE2u:
    if(m==0u&&x==0u&&e==0u){ /* FA Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CE2u,1u);r->open_bus=0xFAu;
  ...
  case 0x019CE3u:
    if(m==0u&&x==0u&&e==0u){ /* C8 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CE3u,1u);r->open_bus=0xC8u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x9CE4u;
  ...
  case 0x019CE4u:
    if(m==0u&&x==0u&&e==0u){ /* C8 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CE4u,1u);r->open_bus=0xC8u;
  ...
  case 0x019CE5u:
    if(m==0u&&x==0u&&e==0u){ /* E8 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CE5u,1u);r->open_bus=0xE8u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x9CE6u;
  ...
  case 0x019CE6u:
    if(m==0u&&x==0u&&e==0u){ /* C6 7F Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CE6u,2u);r->open_bus=0x7Fu;
  ...
  case 0x019CE8u:
    if(m==0u&&x==0u&&e==0u){ /* D0 E8 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CE8u,2u);r->open_bus=0xE8u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x9CEAu;
  ...
  case 0x019CEAu:
    if(m==0u&&x==0u&&e==0u){ /* 68 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CEAu,1u);r->open_bus=0x68u;
  ...
  case 0x019CEBu:
    if(m==0u&&x==0u&&e==0u){ /* 85 7F Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CEBu,2u);r->open_bus=0x7Fu;
  ...
  case 0x019CEDu:
    if(m==0u&&x==0u&&e==0u){ /* A5 7C Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CEDu,2u);r->open_bus=0x7Cu;
  ...
  case 0x019CEFu:
    if(m==0u&&x==0u&&e==0u){ /* 18 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CEFu,1u);r->open_bus=0x18u;
  ...
  case 0x019CF0u:
    if(m==0u&&x==0u&&e==0u){ /* 69 40 00 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CF0u,3u);r->open_bus=0x00u;
  ...
  case 0x019CF3u:
    if(m==0u&&x==0u&&e==0u){ /* 85 7C Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CF3u,2u);r->open_bus=0x7Cu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x9CF5u;
      sc_v11_bus_write16(r,sc_v11_ea_dp(r,0x7Cu),c->a);if((c->d&0xffu)!=0u)sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x019CF5u:
    if(m==0u&&x==0u&&e==0u){ /* C6 82 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CF5u,2u);r->open_bus=0x82u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x9CF7u;
  ...
  case 0x019CF7u:
    if(m==0u&&x==0u&&e==0u){ /* D0 D4 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CF7u,2u);r->open_bus=0xD4u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x9CF9u;
  ...
  case 0x019CF9u:
    if(m==0u&&x==0u&&e==0u){ /* 60 Mesen corrected gameplay frame 4261; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x019CF9u,1u);r->open_bus=0x60u;
