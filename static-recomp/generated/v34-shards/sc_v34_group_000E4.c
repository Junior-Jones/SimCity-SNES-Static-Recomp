...
int sc_v34_group_000E4(SCV11Runtime *r,uint32_t address,uint8_t m,uint8_t x,uint8_t e){
  ...
  case 0x039000u:
    if(m==1u&&x==1u&&e==0u){ /* C0 00 Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039000u,2u);r->open_bus=0x00u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x9002u;
  ...
  case 0x039002u:
    if(m==1u&&x==1u&&e==0u){ /* F0 2B Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039002u,2u);r->open_bus=0x2Bu;
  ...
  case 0x039004u:
    if(m==1u&&x==1u&&e==0u){ /* 88 Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039004u,1u);r->open_bus=0x88u;
  ...
  case 0x039005u:
    if(m==1u&&x==1u&&e==0u){ /* 80 1C Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039005u,2u);r->open_bus=0x1Cu;
  ...
  case 0x039007u:
    if(m==1u&&x==1u&&e==0u){ /* 3A Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039007u,1u);r->open_bus=0x3Au;
  ...
  case 0x039008u:
    if(m==1u&&x==1u&&e==0u){ /* D0 07 Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039008u,2u);r->open_bus=0x07u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x900Au;
  ...
  case 0x03900Au:
    if(m==1u&&x==1u&&e==0u){ /* E0 77 Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03900Au,2u);r->open_bus=0x77u;
  ...
  case 0x03900Cu:
    if(m==1u&&x==1u&&e==0u){ /* F0 21 Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03900Cu,2u);r->open_bus=0x21u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x900Eu;
      if((c->p&SC_FLAG_Z)!=0u){c->pc=0x902Fu;}
  ...
  case 0x03900Eu:
    if(m==1u&&x==1u&&e==0u){ /* E8 Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03900Eu,1u);r->open_bus=0xE8u;
  ...
  case 0x03900Fu:
    if(m==1u&&x==1u&&e==0u){ /* 80 12 Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03900Fu,2u);r->open_bus=0x12u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x9011u;
      if(1){c->pc=0x9023u;}
  ...
  case 0x039011u:
    if(m==1u&&x==1u&&e==0u){ /* 3A Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039011u,1u);r->open_bus=0x3Au;
  ...
  case 0x039012u:
    if(m==1u&&x==1u&&e==0u){ /* D0 07 Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039012u,2u);r->open_bus=0x07u;
  ...
  case 0x039014u:
    if(m==1u&&x==1u&&e==0u){ /* C0 63 Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039014u,2u);r->open_bus=0x63u;
  ...
  case 0x039016u:
    if(m==1u&&x==1u&&e==0u){ /* F0 17 Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039016u,2u);r->open_bus=0x17u;
  ...
  case 0x039018u:
    if(m==1u&&x==1u&&e==0u){ /* C8 Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039018u,1u);r->open_bus=0xC8u;
  ...
  case 0x039019u:
    if(m==1u&&x==1u&&e==0u){ /* 80 08 Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039019u,2u);r->open_bus=0x08u;
  ...
  case 0x03901Bu:
    if(m==1u&&x==1u&&e==0u){ /* 3A Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03901Bu,1u);r->open_bus=0x3Au;
  ...
  case 0x03901Cu:
    if(m==1u&&x==1u&&e==0u){ /* D0 05 Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03901Cu,2u);r->open_bus=0x05u;
  ...
  case 0x03901Eu:
    if(m==1u&&x==1u&&e==0u){ /* E0 00 Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03901Eu,2u);r->open_bus=0x00u;
  ...
  case 0x039020u:
    if(m==1u&&x==1u&&e==0u){ /* F0 0D Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039020u,2u);r->open_bus=0x0Du;
  ...
  case 0x039022u:
    if(m==1u&&x==1u&&e==0u){ /* CA Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039022u,1u);r->open_bus=0xCAu;
  ...
  case 0x039023u:
    if(m==1u&&x==1u&&e==0u){ /* 8E 85 0B Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039023u,3u);r->open_bus=0x0Bu;
  ...
  case 0x039026u:
    if(m==1u&&x==1u&&e==0u){ /* 8C 86 0B Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039026u,3u);r->open_bus=0x0Bu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x9029u;
  ...
  case 0x039029u:
    if(m==1u&&x==1u&&e==0u){ /* C2 30 Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039029u,2u);r->open_bus=0x30u;
  ...
  case 0x03902Bu:
    if(m==0u&&x==0u&&e==0u){ /* A9 01 00 Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03902Bu,3u);r->open_bus=0x00u;
  ...
  case 0x03902Eu:
    if(m==0u&&x==0u&&e==0u){ /* 60 Mesen corrected gameplay frame 3834; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03902Eu,1u);r->open_bus=0x60u;
  ...
  case 0x039069u:
    if(m==0u&&x==0u&&e==0u){ /* AD CF 0C Mesen corrected gameplay frame 2549; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039069u,3u);r->open_bus=0x0Cu;
  ...
  case 0x03906Cu:
    if(m==0u&&x==0u&&e==0u){ /* 29 FF 7F Mesen corrected gameplay frame 2549; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03906Cu,3u);r->open_bus=0x7Fu;
  ...
  case 0x03906Fu:
    if(m==0u&&x==0u&&e==0u){ /* 85 00 Mesen corrected gameplay frame 2549; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03906Fu,2u);r->open_bus=0x00u;
  ...
  case 0x039071u:
    if(m==0u&&x==0u&&e==0u){ /* 20 CF A3 Mesen corrected gameplay frame 2549; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039071u,3u);r->open_bus=0xA3u;
  ...
  case 0x039077u:
    if(m==0u&&x==0u&&e==0u){ /* A5 00 Mesen corrected gameplay frame 2549; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039077u,2u);r->open_bus=0x00u;
  ...
  case 0x039079u:
    if(m==0u&&x==0u&&e==0u){ /* 7A Mesen corrected gameplay frame 2549; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039079u,1u);r->open_bus=0x7Au;
  ...
  case 0x03907Au:
    if(m==0u&&x==0u&&e==0u){ /* FA Mesen corrected gameplay frame 2549; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03907Au,1u);r->open_bus=0xFAu;
  ...
  case 0x03907Bu:
    if(m==0u&&x==0u&&e==0u){ /* 2B Mesen corrected gameplay frame 2549; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03907Bu,1u);r->open_bus=0x2Bu;
  ...
  case 0x03907Cu:
    if(m==0u&&x==0u&&e==0u){ /* 28 Mesen corrected gameplay frame 2549; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03907Cu,1u);r->open_bus=0x28u;
  ...
  case 0x0390A7u:
    if(m==0u&&x==0u&&e==0u){ /* C2 20 Mesen corrected gameplay frame 2549; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x0390A7u,2u);r->open_bus=0x20u;
  ...
  case 0x0390A9u:
    if(m==0u&&x==0u&&e==0u){ /* A2 0C 00 Mesen corrected gameplay frame 2549; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x0390A9u,3u);r->open_bus=0x00u;
  ...
  case 0x0390ACu:
    if(m==0u&&x==0u&&e==0u){ /* BD B7 90 Mesen corrected gameplay frame 2549; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x0390ACu,3u);r->open_bus=0x90u;
  ...
  case 0x0390AFu:
    if(m==0u&&x==0u&&e==0u){ /* 9D CF 0C Mesen corrected gameplay frame 2549; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x0390AFu,3u);r->open_bus=0x0Cu;
  ...
  case 0x0390B2u:
    if(m==0u&&x==0u&&e==0u){ /* CA Mesen corrected gameplay frame 2549; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x0390B2u,1u);r->open_bus=0xCAu;
  ...
  case 0x0390B3u:
    if(m==0u&&x==0u&&e==0u){ /* CA Mesen corrected gameplay frame 2549; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x0390B3u,1u);r->open_bus=0xCAu;
  ...
  case 0x0390B4u:
    if(m==0u&&x==0u&&e==0u){ /* 10 F6 Mesen corrected gameplay frame 2549; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x0390B4u,2u);r->open_bus=0xF6u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x90B6u;
  ...
  case 0x0390B6u:
    if(m==0u&&x==0u&&e==0u){ /* 60 Mesen corrected gameplay frame 2549; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x0390B6u,1u);r->open_bus=0x60u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x90B7u;
      {uint16_t q;sc_v11_scheduler_internal_cycle(r,2u);q=sc_v11_pop16(r);sc_v11_scheduler_internal_cycle(r,1u);c->pc=(uint16_t)(q+1u);}
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x0390C7u:
    if(m==0u&&x==0u&&e==0u){ /* 20 37 91 Mesen corrected gameplay frame 3716; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x0390C7u,3u);r->open_bus=0x91u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x90CAu;
  ...
  case 0x039137u:
    if(m==0u&&x==0u&&e==0u){ /* AD 49 0B Mesen corrected gameplay frame 3716; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039137u,3u);r->open_bus=0x0Bu;
  ...
  case 0x03913Au:
    if(m==0u&&x==0u&&e==0u){ /* 38 Mesen corrected gameplay frame 3716; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03913Au,1u);r->open_bus=0x38u;
  ...
  case 0x03913Bu:
    if(m==0u&&x==0u&&e==0u){ /* E9 D0 02 Mesen corrected gameplay frame 3716; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03913Bu,3u);r->open_bus=0x02u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x913Eu;
  ...
  case 0x03913Eu:
    if(m==0u&&x==0u&&e==0u){ /* AA Mesen corrected gameplay frame 3716; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03913Eu,1u);r->open_bus=0xAAu;
  ...
  case 0x03913Fu:
    if(m==0u&&x==0u&&e==0u){ /* AD 89 0B Mesen corrected gameplay frame 3716; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x03913Fu,3u);r->open_bus=0x0Bu;
  ...
  case 0x039142u:
    if(m==0u&&x==0u&&e==0u){ /* C9 7A 03 Mesen corrected gameplay frame 3716; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039142u,3u);r->open_bus=0x03u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x9145u;
  ...
  case 0x039145u:
    if(m==0u&&x==0u&&e==0u){ /* 90 EF Mesen corrected gameplay frame 3716; Version 34 gameplay route */
      sc_v11_scheduler_code_access(r,0x039145u,2u);r->open_bus=0xEFu;
