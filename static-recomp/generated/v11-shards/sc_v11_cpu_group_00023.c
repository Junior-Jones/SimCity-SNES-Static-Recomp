...
int sc_v11_cpu_group_00023(SCV11Runtime *r,uint32_t address,uint8_t m,uint8_t x){
  ...
  case 0x008E75u:
    if(m==0u&&x==0u){ /* E220 SEP imm; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E75u,2u,0x20u,0x8E77u);
  ...
  case 0x008E77u:
    if(m==1u&&x==0u){ /* A5B3 LDA dp; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E77u,2u,0xB3u,0x8E79u);
  ...
  case 0x008E79u:
    if(m==1u&&x==0u){ /* 48 PHA imp; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E79u,1u,0x48u,0x8E7Au);
  ...
  case 0x008E7Au:
    if(m==1u&&x==0u){ /* E220 SEP imm; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E7Au,2u,0x20u,0x8E7Cu);
      sc_v11_unpack_p(c,(uint8_t)(c->p|0x20u));sc_v11_scheduler_internal_cycle(r,1u);
      SC_STATIC_CONTEXT_END();
    }
    break;
  case 0x008E7Cu:
    if(m==1u&&x==0u){ /* A5B3 LDA dp; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E7Cu,2u,0xB3u,0x8E7Eu);
      sc_v11_op_lda(r,sc_v11_bus_read8(r,sc_v11_ea_dp(r,0x00B3u)),8u);if((c->d&0xffu)!=0u)sc_v11_scheduler_internal_cycle(r,1u);
      SC_STATIC_CONTEXT_END();
    }
    break;
  case 0x008E7Eu:
    if(m==1u&&x==0u){ /* 0980 ORA imm; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E7Eu,2u,0x80u,0x8E80u);
  ...
  case 0x008E80u:
    if(m==1u&&x==0u){ /* 85B1 STA dp; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E80u,2u,0xB1u,0x8E82u);
  ...
  case 0x008E82u:
    if(m==1u&&x==0u){ /* E220 SEP imm; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E82u,2u,0x20u,0x8E84u);
      sc_v11_unpack_p(c,(uint8_t)(c->p|0x20u));sc_v11_scheduler_internal_cycle(r,1u);
      SC_STATIC_CONTEXT_END();
    }
    break;
  case 0x008E84u:
    if(m==1u&&x==0u){ /* A90F LDA imm; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E84u,2u,0x0Fu,0x8E86u);
  ...
  case 0x008E86u:
    if(m==1u&&x==0u){ /* 48 PHA imp; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E86u,1u,0x48u,0x8E87u);
      sc_v11_scheduler_internal_cycle(r,1u);if(!sc_v11_push8(r,(uint8_t)c->a))return 0;
      SC_STATIC_CONTEXT_END();
    }
    break;
  case 0x008E87u:
    if(m==1u&&x==0u){ /* C220 REP imm; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E87u,2u,0x20u,0x8E89u);
  ...
  case 0x008E89u:
    if(m==0u&&x==0u){ /* A90000 LDA imm; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E89u,3u,0x00u,0x8E8Cu);
  ...
  case 0x008E8Cu:
    if(m==0u&&x==0u){ /* 0200 COP imm; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E8Cu,2u,0x00u,0x8E8Eu);
      if(c->emulation)return sc_v11_fail(r,r->current_instruction_address,"emulation-mode COP is outside the certified route");
      if(!sc_v11_push8(r,c->pbr))return 0;
  ...
  case 0x008E9Fu:
    if(m==0u&&x==0u){ /* 0200 COP imm; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E9Fu,2u,0x00u,0x8EA1u);
      if(c->emulation)return sc_v11_fail(r,r->current_instruction_address,"emulation-mode COP is outside the certified route");
      if(!sc_v11_push8(r,c->pbr))return 0;
      if(!sc_v11_push16(r,c->pc))return 0;
      if(!sc_v11_push8(r,c->p))return 0;
  ...
  case 0x008E8Eu:
    if(m==0u&&x==0u){ /* E220 SEP imm; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E8Eu,2u,0x20u,0x8E90u);
      sc_v11_unpack_p(c,(uint8_t)(c->p|0x20u));sc_v11_scheduler_internal_cycle(r,1u);
      SC_STATIC_CONTEXT_END();
    }
    break;
  case 0x008E90u:
    if(m==1u&&x==0u){ /* 68 PLA imp; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E90u,1u,0x68u,0x8E91u);
  ...
  case 0x008E91u:
    if(m==1u&&x==0u){ /* 855F STA dp; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E91u,2u,0x5Fu,0x8E93u);
  ...
  case 0x008E93u:
    if(m==1u&&x==0u){ /* 3A DEC acc; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E93u,1u,0x3Au,0x8E94u);
  ...
  case 0x008E94u:
    if(m==1u&&x==0u){ /* 10F0 BPL rel; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E94u,2u,0xF0u,0x8E96u);
  ...
  case 0x008E96u:
    if(m==1u&&x==0u){ /* A98F LDA imm; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E96u,2u,0x8Fu,0x8E98u);
  ...
  case 0x008E98u:
    if(m==1u&&x==0u){ /* 855F STA dp; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E98u,2u,0x5Fu,0x8E9Au);
      {uint32_t a=sc_v11_ea_dp(r,0x005Fu);sc_v11_bus_write8(r,a,(uint8_t)c->a);}if((c->d&0xffu)!=0u)sc_v11_scheduler_internal_cycle(r,1u);
      SC_STATIC_CONTEXT_END();
    }
    break;
  case 0x008E9Au:
    if(m==1u&&x==0u){ /* C220 REP imm; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E9Au,2u,0x20u,0x8E9Cu);
      sc_v11_unpack_p(c,(uint8_t)(c->p&((uint8_t)~0x20u)));sc_v11_scheduler_internal_cycle(r,1u);
      SC_STATIC_CONTEXT_END();
    }
    break;
  case 0x008E9Cu:
    if(m==0u&&x==0u){ /* A90000 LDA imm; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008E9Cu,3u,0x00u,0x8E9Fu);
      sc_v11_op_lda(r,0u,16u);
      SC_STATIC_CONTEXT_END();
    }
    break;
  case 0x008EA1u:
    if(m==0u&&x==0u){ /* E220 SEP imm; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008EA1u,2u,0x20u,0x8EA3u);
      sc_v11_unpack_p(c,(uint8_t)(c->p|0x20u));sc_v11_scheduler_internal_cycle(r,1u);
      SC_STATIC_CONTEXT_END();
    }
    break;
  case 0x008EA3u:
    if(m==1u&&x==0u){ /* 68 PLA imp; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008EA3u,1u,0x68u,0x8EA4u);
      sc_v11_scheduler_internal_cycle(r,2u);sc_v11_op_lda(r,sc_v11_pop8(r),8u);
      SC_STATIC_CONTEXT_END();
    }
    break;
  case 0x008EA4u:
    if(m==1u&&x==0u){ /* 85B3 STA dp; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008EA4u,2u,0xB3u,0x8EA6u);
  ...
  case 0x008EA6u:
    if(m==1u&&x==0u){ /* 85B1 STA dp; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008EA6u,2u,0xB1u,0x8EA8u);
      {uint32_t a=sc_v11_ea_dp(r,0x00B1u);sc_v11_bus_write8(r,a,(uint8_t)c->a);}if((c->d&0xffu)!=0u)sc_v11_scheduler_internal_cycle(r,1u);
      SC_STATIC_CONTEXT_END();
    }
    break;
  case 0x008EA8u:
    if(m==1u&&x==0u){ /* 60 RTS imp; Version 13 reverse-fade COP service */
      SC_STATIC_CONTEXT_BEGIN(0x008EA8u,1u,0x60u,0x8EA9u);
