...
int sc_v11_cpu_group_000F8(SCV11Runtime *r,uint32_t address,uint8_t m,uint8_t x){
  ...
  case 0x03E000u:
    if(m==1u&&x==0u){ /* 860E STX dp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E000u,2u);r->open_bus=0x0Eu;
  ...
  case 0x03E002u:
    if(m==1u&&x==0u){ /* C220 REP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E002u,2u);r->open_bus=0x20u;
  ...
  case 0x03E004u:
    if(m==0u&&x==0u){ /* A90800 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E004u,3u);r->open_bus=0x00u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE007u;
      sc_v11_op_lda(r,0x0008u,16u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E007u:
    if(m==0u&&x==0u){ /* 0200 COP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E007u,2u);r->open_bus=0x00u;
  ...
  case 0x03E009u:
    if(m==0u&&x==0u){ /* E220 SEP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E009u,2u);r->open_bus=0x20u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE00Bu;
  ...
  case 0x03E00Bu:
    if(m==1u&&x==0u){ /* C210 REP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E00Bu,2u);r->open_bus=0x10u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE00Du;
  ...
  case 0x03E00Du:
    if(m==1u&&x==0u){ /* A2CB87 LDX imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E00Du,3u);r->open_bus=0x87u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE010u;
  ...
  case 0x03E010u:
    if(m==1u&&x==0u){ /* 8609 STX dp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E010u,2u);r->open_bus=0x09u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE012u;
  ...
  case 0x03E012u:
    if(m==1u&&x==0u){ /* A90C LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E012u,2u);r->open_bus=0x0Cu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE014u;
  ...
  case 0x03E014u:
    if(m==1u&&x==0u){ /* 850B STA dp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E014u,2u);r->open_bus=0x0Bu;
  ...
  case 0x03E016u:
    if(m==1u&&x==0u){ /* A20020 LDX imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E016u,3u);r->open_bus=0x20u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE019u;
  ...
  case 0x03E019u:
    if(m==1u&&x==0u){ /* 860E STX dp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E019u,2u);r->open_bus=0x0Eu;
  ...
  case 0x03E01Bu:
    if(m==1u&&x==0u){ /* C220 REP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E01Bu,2u);r->open_bus=0x20u;
  ...
  case 0x03E01Du:
    if(m==0u&&x==0u){ /* A90800 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E01Du,3u);r->open_bus=0x00u;
  ...
  case 0x03E020u:
    if(m==0u&&x==0u){ /* 0200 COP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E020u,2u);r->open_bus=0x00u;
  ...
  case 0x03E022u:
    if(m==0u&&x==0u){ /* E220 SEP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E022u,2u);r->open_bus=0x20u;
  ...
  case 0x03E024u:
    if(m==1u&&x==0u){ /* C210 REP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E024u,2u);r->open_bus=0x10u;
  ...
  case 0x03E026u:
    if(m==1u&&x==0u){ /* A2B989 LDX imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E026u,3u);r->open_bus=0x89u;
  ...
  case 0x03E029u:
    if(m==1u&&x==0u){ /* 8609 STX dp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E029u,2u);r->open_bus=0x09u;
  ...
  case 0x03E02Bu:
    if(m==1u&&x==0u){ /* A90C LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E02Bu,2u);r->open_bus=0x0Cu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE02Du;
      sc_v11_op_lda(r,0x000Cu,8u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E02Du:
    if(m==1u&&x==0u){ /* 850B STA dp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E02Du,2u);r->open_bus=0x0Bu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE02Fu;
      {uint32_t a=sc_v11_ea_dp(r,0x000Bu);sc_v11_bus_write8(r,a,(uint8_t)c->a);}if((c->d&0xffu)!=0u)sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E02Fu:
    if(m==1u&&x==0u){ /* A20028 LDX imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E02Fu,3u);r->open_bus=0x28u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE032u;
  ...
  case 0x03E032u:
    if(m==1u&&x==0u){ /* 860E STX dp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E032u,2u);r->open_bus=0x0Eu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE034u;
      {uint32_t a=sc_v11_ea_dp(r,0x000Eu);sc_v11_bus_write16(r,a,c->x);}if((c->d&0xffu)!=0u)sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E034u:
    if(m==1u&&x==0u){ /* C220 REP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E034u,2u);r->open_bus=0x20u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE036u;
      sc_v11_unpack_p(c,(uint8_t)(c->p&((uint8_t)~0x20u)));sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E036u:
    if(m==0u&&x==0u){ /* A90800 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E036u,3u);r->open_bus=0x00u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE039u;
      sc_v11_op_lda(r,0x0008u,16u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E039u:
    if(m==0u&&x==0u){ /* 0200 COP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E039u,2u);r->open_bus=0x00u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE03Bu;
      if(c->emulation)return sc_v11_fail(r,r->current_instruction_address,"emulation-mode COP is outside the certified route");
            if(!sc_v11_push8(r,c->pbr))return 0;
            if(!sc_v11_push16(r,c->pc))return 0;
            if(!sc_v11_push8(r,c->p))return 0;
  ...
  case 0x03E03Bu:
    if(m==0u&&x==0u){ /* E220 SEP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E03Bu,2u);r->open_bus=0x20u;
  ...
  case 0x03E03Du:
    if(m==1u&&x==0u){ /* C210 REP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E03Du,2u);r->open_bus=0x10u;
  ...
  case 0x03E03Fu:
    if(m==1u&&x==0u){ /* A20040 LDX imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E03Fu,3u);r->open_bus=0x40u;
  ...
  case 0x03E042u:
    if(m==1u&&x==0u){ /* 8E1621 STX abs; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E042u,3u);r->open_bus=0x21u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE045u;
  ...
  case 0x03E045u:
    if(m==1u&&x==0u){ /* E230 SEP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E045u,2u);r->open_bus=0x30u;
  ...
  case 0x03E047u:
    if(m==1u&&x==1u){ /* A902 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E047u,2u);r->open_bus=0x02u;
  ...
  case 0x03E049u:
    if(m==1u&&x==1u){ /* 0A ASL acc; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E049u,1u);r->open_bus=0x0Au;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE04Au;
  ...
  case 0x03E04Au:
    if(m==1u&&x==1u){ /* 0A ASL acc; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E04Au,1u);r->open_bus=0x0Au;
  ...
  case 0x03E04Bu:
    if(m==1u&&x==1u){ /* 0A ASL acc; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E04Bu,1u);r->open_bus=0x0Au;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE04Cu;
      sc_v11_op_shift_accumulator(r,8u,0u);sc_v11_scheduler_idle_or_read(r);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E04Cu:
    if(m==1u&&x==1u){ /* 0A ASL acc; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E04Cu,1u);r->open_bus=0x0Au;
  ...
  case 0x03E04Du:
    if(m==1u&&x==1u){ /* AA TAX imp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E04Du,1u);r->open_bus=0xAAu;
  ...
  case 0x03E04Eu:
    if(m==1u&&x==1u){ /* A901 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E04Eu,2u);r->open_bus=0x01u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE050u;
  ...
  case 0x03E050u:
    if(m==1u&&x==1u){ /* 9D0043 STA abs,x; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E050u,3u);r->open_bus=0x43u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE053u;
  ...
  case 0x03E053u:
    if(m==1u&&x==1u){ /* A918 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E053u,2u);r->open_bus=0x18u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE055u;
  ...
  case 0x03E055u:
    if(m==1u&&x==1u){ /* 9D0143 STA abs,x; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E055u,3u);r->open_bus=0x43u;
  ...
  case 0x03E058u:
    if(m==1u&&x==1u){ /* A900 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E058u,2u);r->open_bus=0x00u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE05Au;
  ...
  case 0x03E05Au:
    if(m==1u&&x==1u){ /* 9D0243 STA abs,x; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E05Au,3u);r->open_bus=0x43u;
  ...
  case 0x03E05Du:
    if(m==1u&&x==1u){ /* A980 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E05Du,2u);r->open_bus=0x80u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE05Fu;
  ...
  case 0x03E05Fu:
    if(m==1u&&x==1u){ /* 9D0343 STA abs,x; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E05Fu,3u);r->open_bus=0x43u;
  ...
  case 0x03E062u:
    if(m==1u&&x==1u){ /* A97E LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E062u,2u);r->open_bus=0x7Eu;
  ...
  case 0x03E064u:
    if(m==1u&&x==1u){ /* 9D0443 STA abs,x; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E064u,3u);r->open_bus=0x43u;
  ...
  case 0x03E067u:
    if(m==1u&&x==1u){ /* A900 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E067u,2u);r->open_bus=0x00u;
  ...
  case 0x03E069u:
    if(m==1u&&x==1u){ /* 9D0543 STA abs,x; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E069u,3u);r->open_bus=0x43u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE06Cu;
  ...
  case 0x03E06Cu:
    if(m==1u&&x==1u){ /* A930 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E06Cu,2u);r->open_bus=0x30u;
  ...
  case 0x03E06Eu:
    if(m==1u&&x==1u){ /* 9D0643 STA abs,x; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E06Eu,3u);r->open_bus=0x43u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE071u;
  ...
  case 0x03E071u:
    if(m==1u&&x==1u){ /* A901 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E071u,2u);r->open_bus=0x01u;
  ...
  case 0x03E073u:
    if(m==1u&&x==1u){ /* A202 LDX imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E073u,2u);r->open_bus=0x02u;
  ...
  case 0x03E075u:
    if(m==1u&&x==1u){ /* F004 BEQ rel; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E075u,2u);r->open_bus=0x04u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE077u;
  ...
  case 0x03E077u:
    if(m==1u&&x==1u){ /* 0A ASL acc; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E077u,1u);r->open_bus=0x0Au;
  ...
  case 0x03E078u:
    if(m==1u&&x==1u){ /* CA DEX imp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E078u,1u);r->open_bus=0xCAu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE079u;
  ...
  case 0x03E079u:
    if(m==1u&&x==1u){ /* D0FC BNE rel; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E079u,2u);r->open_bus=0xFCu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE07Bu;
  ...
  case 0x03E07Bu:
    if(m==1u&&x==1u){ /* 8D0B42 STA abs; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E07Bu,3u);r->open_bus=0x42u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE07Eu;
  ...
  case 0x03E07Eu:
    if(m==1u&&x==1u){ /* E220 SEP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E07Eu,2u);r->open_bus=0x20u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE080u;
      sc_v11_unpack_p(c,(uint8_t)(c->p|0x20u));sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E080u:
    if(m==1u&&x==1u){ /* C210 REP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E080u,2u);r->open_bus=0x10u;
  ...
  case 0x03E082u:
    if(m==1u&&x==0u){ /* A260C4 LDX imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E082u,3u);r->open_bus=0xC4u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE085u;
  ...
  case 0x03E085u:
    if(m==1u&&x==0u){ /* 8609 STX dp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E085u,2u);r->open_bus=0x09u;
  ...
  case 0x03E087u:
    if(m==1u&&x==0u){ /* A90A LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E087u,2u);r->open_bus=0x0Au;
  ...
  case 0x03E08Bu:
    if(m==1u&&x==0u){ /* A20000 LDX imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E08Bu,3u);r->open_bus=0x00u;
  ...
  case 0x03E08Eu:
    if(m==1u&&x==0u){ /* 860E STX dp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E08Eu,2u);r->open_bus=0x0Eu;
  ...
  case 0x03E090u:
    if(m==1u&&x==0u){ /* C220 REP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E090u,2u);r->open_bus=0x20u;
  ...
  case 0x03E092u:
    if(m==0u&&x==0u){ /* A90800 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E092u,3u);r->open_bus=0x00u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE095u;
      sc_v11_op_lda(r,0x0008u,16u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E095u:
    if(m==0u&&x==0u){ /* 0200 COP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E095u,2u);r->open_bus=0x00u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE097u;
      if(c->emulation)return sc_v11_fail(r,r->current_instruction_address,"emulation-mode COP is outside the certified route");
            if(!sc_v11_push8(r,c->pbr))return 0;
            if(!sc_v11_push16(r,c->pc))return 0;
            if(!sc_v11_push8(r,c->p))return 0;
  ...
  case 0x03E097u:
    if(m==0u&&x==0u){ /* C220 REP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E097u,2u);r->open_bus=0x20u;
  ...
  case 0x03E099u:
    if(m==0u&&x==0u){ /* A90060 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E099u,3u);r->open_bus=0x60u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE09Cu;
  ...
  case 0x03E09Cu:
    if(m==0u&&x==0u){ /* 8D1621 STA abs; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E09Cu,3u);r->open_bus=0x21u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE09Fu;
  ...
  case 0x03E09Fu:
    if(m==0u&&x==0u){ /* E230 SEP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E09Fu,2u);r->open_bus=0x30u;
  ...
  case 0x03E0A1u:
    if(m==1u&&x==1u){ /* A902 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0A1u,2u);r->open_bus=0x02u;
  ...
  case 0x03E0A3u:
    if(m==1u&&x==1u){ /* 0A ASL acc; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0A3u,1u);r->open_bus=0x0Au;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0A4u;
      sc_v11_op_shift_accumulator(r,8u,0u);sc_v11_scheduler_idle_or_read(r);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E0A4u:
    if(m==1u&&x==1u){ /* 0A ASL acc; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0A4u,1u);r->open_bus=0x0Au;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0A5u;
      sc_v11_op_shift_accumulator(r,8u,0u);sc_v11_scheduler_idle_or_read(r);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E0A5u:
    if(m==1u&&x==1u){ /* 0A ASL acc; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0A5u,1u);r->open_bus=0x0Au;
  ...
  case 0x03E0A6u:
    if(m==1u&&x==1u){ /* 0A ASL acc; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0A6u,1u);r->open_bus=0x0Au;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0A7u;
      sc_v11_op_shift_accumulator(r,8u,0u);sc_v11_scheduler_idle_or_read(r);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E0A7u:
    if(m==1u&&x==1u){ /* AA TAX imp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0A7u,1u);r->open_bus=0xAAu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0A8u;
      c->x=(uint16_t)(c->a&0xffu);sc_v11_set_nz8(c,(uint8_t)c->x);sc_v11_scheduler_idle_or_read(r);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E0A8u:
    if(m==1u&&x==1u){ /* A901 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0A8u,2u);r->open_bus=0x01u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0AAu;
      sc_v11_op_lda(r,0x0001u,8u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E0AAu:
    if(m==1u&&x==1u){ /* 9D0043 STA abs,x; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0AAu,3u);r->open_bus=0x43u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0ADu;
      {uint32_t a=sc_v11_ea_absx(r,0x4300u);sc_v11_bus_write8(r,a,(uint8_t)c->a);}sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E0ADu:
    if(m==1u&&x==1u){ /* A918 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0ADu,2u);r->open_bus=0x18u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0AFu;
      sc_v11_op_lda(r,0x0018u,8u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E0AFu:
    if(m==1u&&x==1u){ /* 9D0143 STA abs,x; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0AFu,3u);r->open_bus=0x43u;
  ...
  case 0x03E0B2u:
    if(m==1u&&x==1u){ /* A900 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0B2u,2u);r->open_bus=0x00u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0B4u;
      sc_v11_op_lda(r,0x0000u,8u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E0B4u:
    if(m==1u&&x==1u){ /* 9D0243 STA abs,x; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0B4u,3u);r->open_bus=0x43u;
  ...
  case 0x03E0B7u:
    if(m==1u&&x==1u){ /* A980 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0B7u,2u);r->open_bus=0x80u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0B9u;
      sc_v11_op_lda(r,0x0080u,8u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E0B9u:
    if(m==1u&&x==1u){ /* 9D0343 STA abs,x; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0B9u,3u);r->open_bus=0x43u;
  ...
  case 0x03E0BCu:
    if(m==1u&&x==1u){ /* A97E LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0BCu,2u);r->open_bus=0x7Eu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0BEu;
      sc_v11_op_lda(r,0x007Eu,8u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E0BEu:
    if(m==1u&&x==1u){ /* 9D0443 STA abs,x; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0BEu,3u);r->open_bus=0x43u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0C1u;
      {uint32_t a=sc_v11_ea_absx(r,0x4304u);sc_v11_bus_write8(r,a,(uint8_t)c->a);}sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E0C1u:
    if(m==1u&&x==1u){ /* A900 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0C1u,2u);r->open_bus=0x00u;
  ...
  case 0x03E0C3u:
    if(m==1u&&x==1u){ /* 9D0543 STA abs,x; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0C3u,3u);r->open_bus=0x43u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0C6u;
      {uint32_t a=sc_v11_ea_absx(r,0x4305u);sc_v11_bus_write8(r,a,(uint8_t)c->a);}sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E0C6u:
    if(m==1u&&x==1u){ /* A910 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0C6u,2u);r->open_bus=0x10u;
  ...
  case 0x03E0C8u:
    if(m==1u&&x==1u){ /* 9D0643 STA abs,x; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0C8u,3u);r->open_bus=0x43u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0CBu;
      {uint32_t a=sc_v11_ea_absx(r,0x4306u);sc_v11_bus_write8(r,a,(uint8_t)c->a);}sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E0CBu:
    if(m==1u&&x==1u){ /* A901 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0CBu,2u);r->open_bus=0x01u;
  ...
  case 0x03E0CDu:
    if(m==1u&&x==1u){ /* A202 LDX imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0CDu,2u);r->open_bus=0x02u;
  ...
  case 0x03E0CFu:
    if(m==1u&&x==1u){ /* F004 BEQ rel; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0CFu,2u);r->open_bus=0x04u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0D1u;
  ...
  case 0x03E0D1u:
    if(m==1u&&x==1u){ /* 0A ASL acc; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0D1u,1u);r->open_bus=0x0Au;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0D2u;
      sc_v11_op_shift_accumulator(r,8u,0u);sc_v11_scheduler_idle_or_read(r);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E0D2u:
    if(m==1u&&x==1u){ /* CA DEX imp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0D2u,1u);r->open_bus=0xCAu;
  ...
  case 0x03E0D3u:
    if(m==1u&&x==1u){ /* D0FC BNE rel; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0D3u,2u);r->open_bus=0xFCu;
  ...
  case 0x03E0D5u:
    if(m==1u&&x==1u){ /* 8D0B42 STA abs; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0D5u,3u);r->open_bus=0x42u;
  ...
  case 0x03E0D8u:
    if(m==1u&&x==1u){ /* E220 SEP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0D8u,2u);r->open_bus=0x20u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0DAu;
      sc_v11_unpack_p(c,(uint8_t)(c->p|0x20u));sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E0DAu:
    if(m==1u&&x==1u){ /* C210 REP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0DAu,2u);r->open_bus=0x10u;
  ...
  case 0x03E0DCu:
    if(m==1u&&x==0u){ /* A2D88E LDX imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0DCu,3u);r->open_bus=0x8Eu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0DFu;
  ...
  case 0x03E0DFu:
    if(m==1u&&x==0u){ /* 8609 STX dp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0DFu,2u);r->open_bus=0x09u;
  ...
  case 0x03E0E5u:
    if(m==1u&&x==0u){ /* A20000 LDX imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0E5u,3u);r->open_bus=0x00u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0E8u;
      sc_v11_op_ldx(r,0x0000u,16u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E0E8u:
    if(m==1u&&x==0u){ /* 860E STX dp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0E8u,2u);r->open_bus=0x0Eu;
  ...
  case 0x03E0EAu:
    if(m==1u&&x==0u){ /* C220 REP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0EAu,2u);r->open_bus=0x20u;
  ...
  case 0x03E0ECu:
    if(m==0u&&x==0u){ /* A90800 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0ECu,3u);r->open_bus=0x00u;
  ...
  case 0x03E0EFu:
    if(m==0u&&x==0u){ /* 0200 COP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0EFu,2u);r->open_bus=0x00u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0F1u;
      if(c->emulation)return sc_v11_fail(r,r->current_instruction_address,"emulation-mode COP is outside the certified route");
            if(!sc_v11_push8(r,c->pbr))return 0;
            if(!sc_v11_push16(r,c->pc))return 0;
            if(!sc_v11_push8(r,c->p))return 0;
  ...
  case 0x03E0F1u:
    if(m==0u&&x==0u){ /* E220 SEP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0F1u,2u);r->open_bus=0x20u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0F3u;
      sc_v11_unpack_p(c,(uint8_t)(c->p|0x20u));sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E0F3u:
    if(m==1u&&x==0u){ /* C210 REP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0F3u,2u);r->open_bus=0x10u;
  ...
  case 0x03E0F5u:
    if(m==1u&&x==0u){ /* 9C2121 STZ abs; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0F5u,3u);r->open_bus=0x21u;
  ...
  case 0x03E0F8u:
    if(m==1u&&x==0u){ /* E230 SEP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0F8u,2u);r->open_bus=0x30u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0FAu;
      sc_v11_unpack_p(c,(uint8_t)(c->p|0x30u));sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E0FAu:
    if(m==1u&&x==1u){ /* A902 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0FAu,2u);r->open_bus=0x02u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0FCu;
      sc_v11_op_lda(r,0x0002u,8u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E0FCu:
    if(m==1u&&x==1u){ /* 0A ASL acc; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0FCu,1u);r->open_bus=0x0Au;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0FDu;
      sc_v11_op_shift_accumulator(r,8u,0u);sc_v11_scheduler_idle_or_read(r);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E0FDu:
    if(m==1u&&x==1u){ /* 0A ASL acc; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0FDu,1u);r->open_bus=0x0Au;
  ...
  case 0x03E0FEu:
    if(m==1u&&x==1u){ /* 0A ASL acc; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0FEu,1u);r->open_bus=0x0Au;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE0FFu;
      sc_v11_op_shift_accumulator(r,8u,0u);sc_v11_scheduler_idle_or_read(r);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E0FFu:
    if(m==1u&&x==1u){ /* 0A ASL acc; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E0FFu,1u);r->open_bus=0x0Au;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE100u;
      sc_v11_op_shift_accumulator(r,8u,0u);sc_v11_scheduler_idle_or_read(r);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E100u:
    if(m==1u&&x==1u){ /* AA TAX imp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E100u,1u);r->open_bus=0xAAu;
  ...
  case 0x03E101u:
    if(m==1u&&x==1u){ /* A900 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E101u,2u);r->open_bus=0x00u;
  ...
  case 0x03E103u:
    if(m==1u&&x==1u){ /* 9D0043 STA abs,x; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E103u,3u);r->open_bus=0x43u;
  ...
  case 0x03E106u:
    if(m==1u&&x==1u){ /* A922 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E106u,2u);r->open_bus=0x22u;
  ...
  case 0x03E108u:
    if(m==1u&&x==1u){ /* 9D0143 STA abs,x; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E108u,3u);r->open_bus=0x43u;
  ...
  case 0x03E10Bu:
    if(m==1u&&x==1u){ /* A900 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E10Bu,2u);r->open_bus=0x00u;
  ...
  case 0x03E10Du:
    if(m==1u&&x==1u){ /* 9D0243 STA abs,x; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E10Du,3u);r->open_bus=0x43u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE110u;
      {uint32_t a=sc_v11_ea_absx(r,0x4302u);sc_v11_bus_write8(r,a,(uint8_t)c->a);}sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E110u:
    if(m==1u&&x==1u){ /* A980 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E110u,2u);r->open_bus=0x80u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE112u;
      sc_v11_op_lda(r,0x0080u,8u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E112u:
    if(m==1u&&x==1u){ /* 9D0343 STA abs,x; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E112u,3u);r->open_bus=0x43u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE115u;
      {uint32_t a=sc_v11_ea_absx(r,0x4303u);sc_v11_bus_write8(r,a,(uint8_t)c->a);}sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E115u:
    if(m==1u&&x==1u){ /* A97E LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E115u,2u);r->open_bus=0x7Eu;
  ...
  case 0x03E117u:
    if(m==1u&&x==1u){ /* 9D0443 STA abs,x; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E117u,3u);r->open_bus=0x43u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE11Au;
      {uint32_t a=sc_v11_ea_absx(r,0x4304u);sc_v11_bus_write8(r,a,(uint8_t)c->a);}sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E11Au:
    if(m==1u&&x==1u){ /* A900 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E11Au,2u);r->open_bus=0x00u;
  ...
  case 0x03E11Cu:
    if(m==1u&&x==1u){ /* 9D0543 STA abs,x; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E11Cu,3u);r->open_bus=0x43u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE11Fu;
      {uint32_t a=sc_v11_ea_absx(r,0x4305u);sc_v11_bus_write8(r,a,(uint8_t)c->a);}sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E11Fu:
    if(m==1u&&x==1u){ /* A902 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E11Fu,2u);r->open_bus=0x02u;
  ...
  case 0x03E121u:
    if(m==1u&&x==1u){ /* 9D0643 STA abs,x; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E121u,3u);r->open_bus=0x43u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE124u;
      {uint32_t a=sc_v11_ea_absx(r,0x4306u);sc_v11_bus_write8(r,a,(uint8_t)c->a);}sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E124u:
    if(m==1u&&x==1u){ /* A901 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E124u,2u);r->open_bus=0x01u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE126u;
      sc_v11_op_lda(r,0x0001u,8u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E126u:
    if(m==1u&&x==1u){ /* A202 LDX imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E126u,2u);r->open_bus=0x02u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE128u;
      sc_v11_op_ldx(r,0x0002u,8u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E128u:
    if(m==1u&&x==1u){ /* F004 BEQ rel; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E128u,2u);r->open_bus=0x04u;
  ...
  case 0x03E12Au:
    if(m==1u&&x==1u){ /* 0A ASL acc; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E12Au,1u);r->open_bus=0x0Au;
  ...
  case 0x03E12Bu:
    if(m==1u&&x==1u){ /* CA DEX imp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E12Bu,1u);r->open_bus=0xCAu;
  ...
  case 0x03E12Cu:
    if(m==1u&&x==1u){ /* D0FC BNE rel; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E12Cu,2u);r->open_bus=0xFCu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE12Eu;
  ...
  case 0x03E12Eu:
    if(m==1u&&x==1u){ /* 8D0B42 STA abs; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E12Eu,3u);r->open_bus=0x42u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE131u;
      {uint32_t a=sc_v11_ea_abs(r,0x420Bu);sc_v11_bus_write8(r,a,(uint8_t)c->a);}
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E131u:
    if(m==1u&&x==1u){ /* C230 REP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E131u,2u);r->open_bus=0x30u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE133u;
      sc_v11_unpack_p(c,(uint8_t)(c->p&((uint8_t)~0x30u)));sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E136u:
    if(m==0u&&x==0u){ /* A90801 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E136u,3u);r->open_bus=0x01u;
  ...
  case 0x03E139u:
    if(m==0u&&x==0u){ /* 8D5D02 STA abs; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E139u,3u);r->open_bus=0x02u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE13Cu;
  ...
  case 0x03E13Cu:
    if(m==0u&&x==0u){ /* A99F00 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E13Cu,3u);r->open_bus=0x00u;
  ...
  case 0x03E13Fu:
    if(m==0u&&x==0u){ /* 8D5F02 STA abs; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E13Fu,3u);r->open_bus=0x02u;
  ...
  case 0x03E142u:
    if(m==0u&&x==0u){ /* A92500 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E142u,3u);r->open_bus=0x00u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE145u;
  ...
  case 0x03E145u:
    if(m==0u&&x==0u){ /* 8D6102 STA abs; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E145u,3u);r->open_bus=0x02u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE148u;
  ...
  case 0x03E148u:
    if(m==0u&&x==0u){ /* C220 REP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E148u,2u);r->open_bus=0x20u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE14Au;
      sc_v11_unpack_p(c,(uint8_t)(c->p&((uint8_t)~0x20u)));sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E14Au:
    if(m==0u&&x==0u){ /* A90200 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E14Au,3u);r->open_bus=0x00u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE14Du;
  ...
  case 0x03E14Du:
    if(m==0u&&x==0u){ /* 0200 COP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E14Du,2u);r->open_bus=0x00u;
  ...
  case 0x03E14Fu:
    if(m==0u&&x==0u){ /* A93200 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E14Fu,3u);r->open_bus=0x00u;
  ...
  case 0x03E152u:
    if(m==0u&&x==0u){ /* 8D5D02 STA abs; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E152u,3u);r->open_bus=0x02u;
  ...
  case 0x03E155u:
    if(m==0u&&x==0u){ /* A9CF00 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E155u,3u);r->open_bus=0x00u;
  ...
  case 0x03E158u:
    if(m==0u&&x==0u){ /* 8D5F02 STA abs; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E158u,3u);r->open_bus=0x02u;
  ...
  case 0x03E15Bu:
    if(m==0u&&x==0u){ /* A92600 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E15Bu,3u);r->open_bus=0x00u;
  ...
  case 0x03E15Eu:
    if(m==0u&&x==0u){ /* 8D6102 STA abs; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E15Eu,3u);r->open_bus=0x02u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE161u;
      {uint32_t a=sc_v11_ea_abs(r,0x0261u);sc_v11_bus_write16(r,a,c->a);}
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E161u:
    if(m==0u&&x==0u){ /* C220 REP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E161u,2u);r->open_bus=0x20u;
  ...
  case 0x03E163u:
    if(m==0u&&x==0u){ /* A90200 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E163u,3u);r->open_bus=0x00u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE166u;
      sc_v11_op_lda(r,0x0002u,16u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E166u:
    if(m==0u&&x==0u){ /* 0200 COP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E166u,2u);r->open_bus=0x00u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE168u;
      if(c->emulation)return sc_v11_fail(r,r->current_instruction_address,"emulation-mode COP is outside the certified route");
            if(!sc_v11_push8(r,c->pbr))return 0;
            if(!sc_v11_push16(r,c->pc))return 0;
            if(!sc_v11_push8(r,c->p))return 0;
  ...
  case 0x03E168u:
    if(m==0u&&x==0u){ /* E220 SEP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E168u,2u);r->open_bus=0x20u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE16Au;
      sc_v11_unpack_p(c,(uint8_t)(c->p|0x20u));sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E16Au:
    if(m==1u&&x==0u){ /* C210 REP imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E16Au,2u);r->open_bus=0x10u;
  ...
  case 0x03E16Cu:
    if(m==1u&&x==0u){ /* 2027E2 JSR abs; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E16Cu,3u);r->open_bus=0xE2u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE16Fu;
  ...
  case 0x03E178u:
    if(m==1u&&x==0u){ /* A902 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E178u,2u);r->open_bus=0x02u;
  ...
  case 0x03E17Au:
    if(m==1u&&x==0u){ /* 8566 STA dp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E17Au,2u);r->open_bus=0x66u;
  ...
  case 0x03E17Cu:
    if(m==1u&&x==0u){ /* A900 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E17Cu,2u);r->open_bus=0x00u;
  ...
  case 0x03E17Eu:
    if(m==1u&&x==0u){ /* 8567 STA dp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E17Eu,2u);r->open_bus=0x67u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE180u;
  ...
  case 0x03E180u:
    if(m==1u&&x==0u){ /* A942 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E180u,2u);r->open_bus=0x42u;
  ...
  case 0x03E182u:
    if(m==1u&&x==0u){ /* 8562 STA dp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E182u,2u);r->open_bus=0x62u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE184u;
  ...
  case 0x03E184u:
    if(m==1u&&x==0u){ /* A94A LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E184u,2u);r->open_bus=0x4Au;
  ...
  case 0x03E186u:
    if(m==1u&&x==0u){ /* 8563 STA dp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E186u,2u);r->open_bus=0x63u;
  ...
  case 0x03E188u:
    if(m==1u&&x==0u){ /* A950 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E188u,2u);r->open_bus=0x50u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE18Au;
  ...
  case 0x03E18Au:
    if(m==1u&&x==0u){ /* 8564 STA dp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E18Au,2u);r->open_bus=0x64u;
  ...
  case 0x03E18Cu:
    if(m==1u&&x==0u){ /* A954 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E18Cu,2u);r->open_bus=0x54u;
  ...
  case 0x03E18Eu:
    if(m==1u&&x==0u){ /* 8565 STA dp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E18Eu,2u);r->open_bus=0x65u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE190u;
  ...
  case 0x03E190u:
    if(m==1u&&x==0u){ /* A917 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E190u,2u);r->open_bus=0x17u;
  ...
  case 0x03E192u:
    if(m==1u&&x==0u){ /* 8568 STA dp; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E192u,2u);r->open_bus=0x68u;
  ...
  case 0x03E194u:
    if(m==1u&&x==0u){ /* A908 LDA imm; Version 14 new-city graphics and DMA setup island */
      sc_v11_scheduler_code_access(r,0x03E194u,2u);r->open_bus=0x08u;
  ...
  case 0x03E227u:
    if(m==1u&&x==0u){ /* A23FE2 LDX imm; Version 14 new-city HDMA table helper */
      sc_v11_scheduler_code_access(r,0x03E227u,3u);r->open_bus=0xE2u;
  ...
  case 0x03E22Au:
    if(m==1u&&x==0u){ /* 8E7243 STX abs; Version 14 new-city HDMA table helper */
      sc_v11_scheduler_code_access(r,0x03E22Au,3u);r->open_bus=0x43u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE22Du;
  ...
  case 0x03E22Du:
    if(m==1u&&x==0u){ /* A903 LDA imm; Version 14 new-city HDMA table helper */
      sc_v11_scheduler_code_access(r,0x03E22Du,2u);r->open_bus=0x03u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE22Fu;
      sc_v11_op_lda(r,0x0003u,8u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E22Fu:
    if(m==1u&&x==0u){ /* 8D7443 STA abs; Version 14 new-city HDMA table helper */
      sc_v11_scheduler_code_access(r,0x03E22Fu,3u);r->open_bus=0x43u;
  ...
  case 0x03E232u:
    if(m==1u&&x==0u){ /* A92C LDA imm; Version 14 new-city HDMA table helper */
      sc_v11_scheduler_code_access(r,0x03E232u,2u);r->open_bus=0x2Cu;
  ...
  case 0x03E234u:
    if(m==1u&&x==0u){ /* 8D7143 STA abs; Version 14 new-city HDMA table helper */
      sc_v11_scheduler_code_access(r,0x03E234u,3u);r->open_bus=0x43u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE237u;
  ...
  case 0x03E237u:
    if(m==1u&&x==0u){ /* 9C7043 STZ abs; Version 14 new-city HDMA table helper */
      sc_v11_scheduler_code_access(r,0x03E237u,3u);r->open_bus=0x43u;
  ...
  case 0x03E23Au:
    if(m==1u&&x==0u){ /* A980 LDA imm; Version 14 new-city HDMA table helper */
      sc_v11_scheduler_code_access(r,0x03E23Au,2u);r->open_bus=0x80u;
  ...
  case 0x03E23Cu:
    if(m==1u&&x==0u){ /* 85B5 STA dp; Version 14 new-city HDMA table helper */
      sc_v11_scheduler_code_access(r,0x03E23Cu,2u);r->open_bus=0xB5u;
  ...
  case 0x03E23Eu:
    if(m==1u&&x==0u){ /* 60 RTS imp; Version 14 new-city HDMA table helper */
      sc_v11_scheduler_code_access(r,0x03E23Eu,1u);r->open_bus=0x60u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE23Fu;
      {uint16_t q;sc_v11_scheduler_internal_cycle(r,2u);q=sc_v11_pop16(r);sc_v11_scheduler_internal_cycle(r,1u);c->pc=(uint16_t)(q+1u);}
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E257u:
    if(m==0u&&x==0u){ /* C230 REP imm; Version 14 auxiliary region new-city-cursor-increment-helper */
      sc_v11_scheduler_code_access(r,0x03E257u,2u);r->open_bus=0x30u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE259u;
      sc_v11_unpack_p(c,(uint8_t)(c->p&((uint8_t)~0x30u)));sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x03E259u:
    if(m==0u&&x==0u){ /* A618 LDX dp; Version 14 auxiliary region new-city-cursor-increment-helper */
      sc_v11_scheduler_code_access(r,0x03E259u,2u);r->open_bus=0x18u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE25Bu;
  ...
  case 0x03E25Bu:
    if(m==0u&&x==0u){ /* F006 BEQ rel; Version 14 auxiliary region new-city-cursor-increment-helper */
      sc_v11_scheduler_code_access(r,0x03E25Bu,2u);r->open_bus=0x06u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE25Du;
  ...
  case 0x03E25Du:
    if(m==0u&&x==0u){ /* E8 INX imp; Version 14 auxiliary region new-city-cursor-increment-helper */
      sc_v11_scheduler_code_access(r,0x03E25Du,1u);r->open_bus=0xE8u;
  ...
  case 0x03E25Eu:
    if(m==0u&&x==0u){ /* 8618 STX dp; Version 14 auxiliary region new-city-cursor-increment-helper */
      sc_v11_scheduler_code_access(r,0x03E25Eu,2u);r->open_bus=0x18u;
  ...
  case 0x03E260u:
    if(m==0u&&x==0u){ /* 861C STX dp; Version 14 auxiliary region new-city-cursor-increment-helper */
      sc_v11_scheduler_code_access(r,0x03E260u,2u);r->open_bus=0x1Cu;
  ...
  case 0x03E262u:
    if(m==0u&&x==0u){ /* 60 RTS imp; Version 14 auxiliary region new-city-cursor-increment-helper */
      sc_v11_scheduler_code_access(r,0x03E262u,1u);r->open_bus=0x60u;
  ...
  case 0x03E263u:
    if(m==0u&&x==0u){ /* A5C9 LDA dp; Version 14 zero-mode value-set path */
      sc_v11_scheduler_code_access(r,0x03E263u,2u);r->open_bus=0xC9u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE265u;
  ...
  case 0x03E265u:
    if(m==0u&&x==0u){ /* 290080 AND imm; Version 14 zero-mode value-set path */
      sc_v11_scheduler_code_access(r,0x03E265u,3u);r->open_bus=0x80u;
  ...
  case 0x03E268u:
    if(m==0u&&x==0u){ /* F018 BEQ rel; Version 14 zero-mode value-set path */
      sc_v11_scheduler_code_access(r,0x03E268u,2u);r->open_bus=0x18u;
  ...
  case 0x03E282u:
    if(m==0u&&x==0u){ /* A5C9 LDA dp; Version 14 zero-mode value-set path */
      sc_v11_scheduler_code_access(r,0x03E282u,2u);r->open_bus=0xC9u;
  ...
  case 0x03E284u:
    if(m==0u&&x==0u){ /* 294000 AND imm; Version 14 zero-mode value-set path */
      sc_v11_scheduler_code_access(r,0x03E284u,3u);r->open_bus=0x00u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE287u;
  ...
  case 0x03E287u:
    if(m==0u&&x==0u){ /* F008 BEQ rel; Version 14 zero-mode value-set path */
      sc_v11_scheduler_code_access(r,0x03E287u,2u);r->open_bus=0x08u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE289u;
  ...
  case 0x03E26Au:
    if(m==0u&&x==0u){ /* 2074E5 JSR abs; Version 14 observed nonzero mode path */
      sc_v11_scheduler_code_access(r,0x03E26Au,3u);r->open_bus=0xE5u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xE26Du;
  ...
  case 0x03E289u:
    if(m==0u&&x==0u){ /* 2074E5 JSR abs; Version 14 observed nonzero mode path */
      sc_v11_scheduler_code_access(r,0x03E289u,3u);r->open_bus=0xE5u;
