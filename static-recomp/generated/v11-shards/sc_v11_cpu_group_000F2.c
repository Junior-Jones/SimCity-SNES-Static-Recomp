...
int sc_v11_cpu_group_000F2(SCV11Runtime *r,uint32_t address,uint8_t m,uint8_t x){
  ...
  case 0x03C874u:
    if(m==0u&&x==0u){ /* A20000 LDX imm; Version 15 B-mode budget defaults island */
      SC_STATIC_CONTEXT_BEGIN(0x03C874u,3u,0x00u,0xC877u);
  ...
  case 0x03C877u:
    if(m==0u&&x==0u){ /* 9F006B7F STA long,x; Version 15 B-mode budget defaults island */
      SC_STATIC_CONTEXT_BEGIN(0x03C877u,4u,0x7Fu,0xC87Bu);
  ...
  case 0x03C87Bu:
    if(m==0u&&x==0u){ /* E8 INX; Version 15 B-mode budget defaults island */
      SC_STATIC_CONTEXT_BEGIN(0x03C87Bu,1u,0xE8u,0xC87Cu);
  ...
  case 0x03C87Cu:
    if(m==0u&&x==0u){ /* E0F48D CPX imm; Version 15 B-mode budget defaults island */
      SC_STATIC_CONTEXT_BEGIN(0x03C87Cu,3u,0x8Du,0xC87Fu);
  ...
  case 0x03C87Fu:
    if(m==0u&&x==0u){ /* D0F6 BNE; Version 15 B-mode budget defaults island */
      SC_STATIC_CONTEXT_BEGIN(0x03C87Fu,2u,0xF6u,0xC881u);
  ...
  case 0x03C881u:
    if(m==0u&&x==0u){ /* 2077B4 JSR; Version 15 B-mode budget defaults island */
      SC_STATIC_CONTEXT_BEGIN(0x03C881u,3u,0xB4u,0xC884u);
  ...
  case 0x03C88Au:
    if(m==0u&&x==0u){ /* AD530B LDA abs; Version 15 B-mode budget defaults island */
      SC_STATIC_CONTEXT_BEGIN(0x03C88Au,3u,0x0Bu,0xC88Du);
  ...
  case 0x03C88Du:
    if(m==0u&&x==0u){ /* 38 SEC; Version 15 B-mode budget defaults island */
      SC_STATIC_CONTEXT_BEGIN(0x03C88Du,1u,0x38u,0xC88Eu);
  ...
  case 0x03C88Eu:
    if(m==0u&&x==0u){ /* E90A00 SBC imm; Version 15 B-mode budget defaults island */
      SC_STATIC_CONTEXT_BEGIN(0x03C88Eu,3u,0x00u,0xC891u);
  ...
  case 0x03C891u:
    if(m==0u&&x==0u){ /* 8DA90D STA abs; Version 15 B-mode budget defaults island */
      SC_STATIC_CONTEXT_BEGIN(0x03C891u,3u,0x0Du,0xC894u);
  ...
  case 0x03C894u:
    if(m==0u&&x==0u){ /* 38 SEC; Version 15 B-mode budget defaults island */
      SC_STATIC_CONTEXT_BEGIN(0x03C894u,1u,0x38u,0xC895u);
      c->p=(uint8_t)(c->p|SC_FLAG_C);sc_v11_scheduler_idle_or_read(r);
      SC_STATIC_CONTEXT_END();
    }
    break;
  case 0x03C895u:
    if(m==0u&&x==0u){ /* E96E00 SBC imm; Version 15 B-mode budget defaults island */
      SC_STATIC_CONTEXT_BEGIN(0x03C895u,3u,0x00u,0xC898u);
  ...
  case 0x03C898u:
    if(m==0u&&x==0u){ /* 8DAB0D STA abs; Version 15 B-mode budget defaults island */
      SC_STATIC_CONTEXT_BEGIN(0x03C898u,3u,0x0Du,0xC89Bu);
  ...
  case 0x03C89Bu:
    if(m==0u&&x==0u){ /* 60 RTS; Version 15 B-mode budget defaults island */
      SC_STATIC_CONTEXT_BEGIN(0x03C89Bu,1u,0x60u,0xC89Cu);
  ...
  case 0x03C89Cu:
    if(m==0u&&x==0u){ /* 60 RTS; Version 15 B-mode budget defaults island */
      SC_STATIC_CONTEXT_BEGIN(0x03C89Cu,1u,0x60u,0xC89Du);
      {uint16_t q;sc_v11_scheduler_internal_cycle(r,2u);q=sc_v11_pop16(r);sc_v11_scheduler_internal_cycle(r,1u);c->pc=(uint16_t)(q+1u);}
      SC_STATIC_CONTEXT_END();
    }
    break;
