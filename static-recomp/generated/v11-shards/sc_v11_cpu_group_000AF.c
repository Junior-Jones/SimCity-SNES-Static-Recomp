...
int sc_v11_cpu_group_000AF(SCV11Runtime *r,uint32_t address,uint8_t m,uint8_t x){
  ...
  case 0x02BC8Eu:
    if(m==0u&&x==0u){ /* 6B RTL imp; Version 13 menu layout and graphics setup islands */
      sc_v11_scheduler_code_access(r,0x02BC8Eu,1u);r->open_bus=0x00u;
  ...
  case 0x02BCC1u:
    if(m==0u&&x==0u){ /* A90E00 LDA imm; Version 13 menu layout and graphics setup islands */
      sc_v11_scheduler_code_access(r,0x02BCC1u,3u);r->open_bus=0x00u;
  ...
  case 0x02BCC4u:
    if(m==0u&&x==0u){ /* 8D6102 STA abs; Version 13 menu layout and graphics setup islands */
      sc_v11_scheduler_code_access(r,0x02BCC4u,3u);r->open_bus=0x02u;
  ...
  case 0x02BCC7u:
    if(m==0u&&x==0u){ /* C220 REP imm; Version 13 menu layout and graphics setup islands */
      sc_v11_scheduler_code_access(r,0x02BCC7u,2u);r->open_bus=0x20u;
  ...
  case 0x02BCC9u:
    if(m==0u&&x==0u){ /* A90200 LDA imm; Version 13 menu layout and graphics setup islands */
      sc_v11_scheduler_code_access(r,0x02BCC9u,3u);r->open_bus=0x00u;
  ...
  case 0x02BCCCu:
    if(m==0u&&x==0u){ /* 0200 COP imm; Version 13 menu layout and graphics setup islands */
      sc_v11_scheduler_code_access(r,0x02BCCCu,2u);r->open_bus=0x00u;
  ...
  case 0x02BCCEu:
    if(m==0u&&x==0u){ /* 8006 BRA rel; Version 13 menu layout and graphics setup islands */
      sc_v11_scheduler_code_access(r,0x02BCCEu,2u);r->open_bus=0x06u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0xBCD0u;
  ...
  case 0x02BCEEu:
    if(m==1u&&x==0u){ /* EB XBA imp; Version 13 menu layout and graphics setup islands */
      sc_v11_scheduler_code_access(r,0x02BCEEu,1u);r->open_bus=0x00u;
  ...
  case 0x02BCF5u:
    if(m==1u&&x==0u){ /* 1A INC acc; Version 13 menu layout and graphics setup islands */
      sc_v11_scheduler_code_access(r,0x02BCF5u,1u);r->open_bus=0x00u;
  ...
  case 0x02BCF6u:
    if(m==1u&&x==0u){ /* 0A ASL acc; Version 13 menu layout and graphics setup islands */
      sc_v11_scheduler_code_access(r,0x02BCF6u,1u);r->open_bus=0x00u;
  ...
  case 0x02BCF7u:
    if(m==1u&&x==0u){ /* 0A ASL acc; Version 13 menu layout and graphics setup islands */
      sc_v11_scheduler_code_access(r,0x02BCF7u,1u);r->open_bus=0x00u;
  ...
  case 0x02BCFAu:
    if(m==1u&&x==0u){ /* AA TAX imp; Version 13 menu layout and graphics setup islands */
      sc_v11_scheduler_code_access(r,0x02BCFAu,1u);r->open_bus=0x00u;
  ...
  case 0x02BD0Du:
    if(m==0u&&x==0u){ /* 6B RTL imp; Version 13 menu layout and graphics setup islands */
      sc_v11_scheduler_code_access(r,0x02BD0Du,1u);r->open_bus=0x00u;
