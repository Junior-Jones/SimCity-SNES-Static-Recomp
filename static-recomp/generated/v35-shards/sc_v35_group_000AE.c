...
int sc_v35_group_000AE(SCV11Runtime *r,uint32_t address,uint8_t m,uint8_t x,uint8_t e){
  ...
  case 0x02BB9Au:
    if(m==1u&&x==1u&&e==1u){ /* A2 DB ; generated town route */
      SC_STATIC_CONTEXT_BEGIN(0x02BB9Au,2u,0xDBu,0xBB9Cu);
  ...
  case 0x02BB9Cu:
    if(m==1u&&x==1u&&e==1u){ /* C4 86 ; generated town route */
      SC_STATIC_CONTEXT_BEGIN(0x02BB9Cu,2u,0x86u,0xBB9Eu);
  ...
  case 0x02BB9Eu:
    if(m==1u&&x==1u&&e==1u){ /* 09 A9 ; generated town route */
      SC_STATIC_CONTEXT_BEGIN(0x02BB9Eu,2u,0xA9u,0xBBA0u);
  ...
  case 0x02BBA0u:
    if(m==1u&&x==1u&&e==1u){ /* 08 ; generated town route */
      SC_STATIC_CONTEXT_BEGIN(0x02BBA0u,1u,0x08u,0xBBA1u);
  ...
  case 0x02BBA1u:
    if(m==1u&&x==1u&&e==1u){ /* 85 0B ; generated town route */
      SC_STATIC_CONTEXT_BEGIN(0x02BBA1u,2u,0x0Bu,0xBBA3u);
  ...
  case 0x02BBA3u:
    if(m==1u&&x==1u&&e==1u){ /* A2 00 ; generated town route */
      SC_STATIC_CONTEXT_BEGIN(0x02BBA3u,2u,0x00u,0xBBA5u);
  ...
  case 0x02BBF4u:
    if(m==1u&&x==1u&&e==1u){ /* A2 D8 ; generated town route */
      SC_STATIC_CONTEXT_BEGIN(0x02BBF4u,2u,0xD8u,0xBBF6u);
  ...
  case 0x02BBF6u:
    if(m==1u&&x==1u&&e==1u){ /* 8A ; generated town route */
      SC_STATIC_CONTEXT_BEGIN(0x02BBF6u,1u,0x8Au,0xBBF7u);
  ...
  case 0x02BBF7u:
    if(m==1u&&x==1u&&e==1u){ /* 86 09 ; generated town route */
      SC_STATIC_CONTEXT_BEGIN(0x02BBF7u,2u,0x09u,0xBBF9u);
  ...
  case 0x02BBF9u:
    if(m==1u&&x==1u&&e==1u){ /* A9 0C ; generated town route */
      SC_STATIC_CONTEXT_BEGIN(0x02BBF9u,2u,0x0Cu,0xBBFBu);
  ...
  case 0x02BBFBu:
    if(m==1u&&x==1u&&e==1u){ /* 85 0B ; generated town route */
      SC_STATIC_CONTEXT_BEGIN(0x02BBFBu,2u,0x0Bu,0xBBFDu);
      sc_v11_bus_write8(r,sc_v11_ea_dp(r,0x0Bu),(uint8_t)c->a);if((c->d&0xffu)!=0u)sc_v11_scheduler_internal_cycle(r,1u);
      SC_STATIC_CONTEXT_END();
    }
    break;
  case 0x02BBFDu:
    if(m==1u&&x==1u&&e==1u){ /* A2 00 ; generated town route */
      SC_STATIC_CONTEXT_BEGIN(0x02BBFDu,2u,0x00u,0xBBFFu);
      sc_v11_op_ldx(r,0x0000u,8u);
      SC_STATIC_CONTEXT_END();
    }
    break;
