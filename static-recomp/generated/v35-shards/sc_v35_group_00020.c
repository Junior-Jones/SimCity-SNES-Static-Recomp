...
int sc_v35_group_00020(SCV11Runtime *r,uint32_t address,uint8_t m,uint8_t x,uint8_t e){
  ...
  case 0x008051u:
    if(m==0u&&x==0u&&e==0u){ /* 64 B7 ; generated town route */
      sc_v11_scheduler_code_access(r,0x008051u,2u);r->open_bus=0xB7u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x8053u;
  ...
  case 0x008053u:
    if(m==0u&&x==0u&&e==0u){ /* 20 65 8D ; generated town route */
      sc_v11_scheduler_code_access(r,0x008053u,3u);r->open_bus=0x8Du;
  ...
  case 0x008056u:
    if(m==0u&&x==0u&&e==0u){ /* 22 83 D2 03 ; generated town route */
      sc_v11_scheduler_code_access(r,0x008056u,4u);r->open_bus=0x03u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x805Au;
  ...
  case 0x00805Fu:
    if(m==0u&&x==0u&&e==0u){ /* 80 EC ; generated town route */
      sc_v11_scheduler_code_access(r,0x00805Fu,2u);r->open_bus=0xECu;
  ...
  case 0x0080C8u:
    if(m==1u&&x==1u&&e==1u){ /* A9 00 ; generated town route */
      sc_v11_scheduler_code_access(r,0x0080C8u,2u);r->open_bus=0x00u;
  ...
  case 0x00810Fu:
    if(m==0u&&x==0u&&e==0u){ /* CE 03 01 ; generated town route */
      sc_v11_scheduler_code_access(r,0x00810Fu,3u);r->open_bus=0x01u;
  ...
  case 0x008117u:
    if(m==0u&&x==0u&&e==0u){ /* CE 0F 01 ; generated town route */
      sc_v11_scheduler_code_access(r,0x008117u,3u);r->open_bus=0x01u;
  ...
  case 0x008126u:
    if(m==0u&&x==0u&&e==0u){ /* C6 56 ; generated town route */
      sc_v11_scheduler_code_access(r,0x008126u,2u);r->open_bus=0x56u;
  ...
  case 0x008128u:
    ...
    else if(m==0u&&x==1u&&e==0u){ /* AD 8D 03 ; generated town route */
      sc_v11_scheduler_code_access(r,0x008128u,3u);r->open_bus=0x03u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x812Bu;
      sc_v11_op_lda(r,sc_v11_bus_read16(r,sc_v11_ea_abs(r,0x038Du)),16u);
      if(!sc_v11_finish_instruction(r))return 0;
  ...
  case 0x00812Du:
    if(m==0u&&x==0u&&e==0u){ /* CE 8D 03 ; generated town route */
      sc_v11_scheduler_code_access(r,0x00812Du,3u);r->open_bus=0x03u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x8130u;
    ...
    break;
  case 0x008130u:
    if(m==0u&&x==0u&&e==0u){ /* 20 FA C1 ; generated town route */
    ...
    else if(m==0u&&x==1u&&e==0u){ /* 20 FA C1 ; generated town route */
      sc_v11_scheduler_code_access(r,0x008130u,3u);r->open_bus=0xC1u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x8133u;
      sc_v11_scheduler_internal_cycle(r,1u);if(!sc_v11_push16(r,0x8132u))return 0;c->pc=0xC1FAu;
      if(!sc_v11_finish_instruction(r))return 0;
  ...
  case 0x00813Au:
    if(m==0u&&x==0u&&e==0u){ /* 20 F9 C3 ; generated town route */
      sc_v11_scheduler_code_access(r,0x00813Au,3u);r->open_bus=0xC3u;
  ...
  case 0x00813Du:
    if(m==0u&&x==0u&&e==0u){ /* 80 12 ; generated town route */
      sc_v11_scheduler_code_access(r,0x00813Du,2u);r->open_bus=0x12u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x813Fu;
      if(1){c->pc=0x8151u;}
  ...
  case 0x00816Au:
    if(m==0u&&x==1u&&e==0u){ /* 29 F0 FF ; generated town route */
      ...
      sc_v11_scheduler_code_access(r,0x00816Au,2u);r->open_bus=0xF0u;
  ...
  case 0x00816Cu:
    if(m==1u&&x==0u&&e==0u){ /* FF D0 24 3B ; generated town route */
      sc_v11_scheduler_code_access(r,0x00816Cu,4u);r->open_bus=0x3Bu;
  ...
  case 0x008175u:
    if(m==0u&&x==1u&&e==0u){ /* A9 01 00 ; generated town route */
      ...
      sc_v11_scheduler_code_access(r,0x008175u,2u);r->open_bus=0x01u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x8177u;
      sc_v11_op_lda(r,0x0001u,8u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x00817Fu:
    if(m==0u&&x==1u&&e==0u){ /* 29 F0 FF ; generated town route */
      ...
      sc_v11_scheduler_code_access(r,0x00817Fu,2u);r->open_bus=0xF0u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x8181u;
      sc_v11_op_and(r,0x00F0u,8u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x008181u:
    if(m==1u&&x==0u&&e==0u){ /* FF D0 07 A5 ; generated town route */
      sc_v11_scheduler_code_access(r,0x008181u,4u);r->open_bus=0xA5u;
  ...
  case 0x0083ACu:
    if(m==0u&&x==0u&&e==0u){ /* 60 ; generated town route */
      sc_v11_scheduler_code_access(r,0x0083ACu,1u);r->open_bus=0x60u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x83ADu;
      {uint16_t q;sc_v11_scheduler_internal_cycle(r,2u);q=sc_v11_pop16(r);sc_v11_scheduler_internal_cycle(r,1u);c->pc=(uint16_t)(q+1u);}
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x0083B8u:
    if(m==0u&&x==0u&&e==0u){ /* E2 20 ; generated town route */
      sc_v11_scheduler_code_access(r,0x0083B8u,2u);r->open_bus=0x20u;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x83BAu;
      sc_v11_unpack_p(c,(uint8_t)(c->p|0x20u));sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x0083BAu:
    if(m==1u&&x==0u&&e==0u){ /* A9 0E ; generated town route */
      sc_v11_scheduler_code_access(r,0x0083BAu,2u);r->open_bus=0x0Eu;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x83BCu;
  ...
  case 0x0083BCu:
    if(m==1u&&x==0u&&e==0u){ /* 85 71 ; generated town route */
      sc_v11_scheduler_code_access(r,0x0083BCu,2u);r->open_bus=0x71u;
  ...
  case 0x0083BEu:
    if(m==1u&&x==0u&&e==0u){ /* A9 07 ; generated town route */
      sc_v11_scheduler_code_access(r,0x0083BEu,2u);r->open_bus=0x07u;
  ...
  case 0x0083C0u:
    if(m==1u&&x==0u&&e==0u){ /* 85 6A ; generated town route */
      sc_v11_scheduler_code_access(r,0x0083C0u,2u);r->open_bus=0x6Au;
      r->scheduler.cpu_instructions++;r->generated_callbacks++;r->machine.static_executed_instructions=(uint32_t)r->scheduler.cpu_instructions;c->pc=0x83C2u;
      sc_v11_bus_write8(r,sc_v11_ea_dp(r,0x6Au),(uint8_t)c->a);if((c->d&0xffu)!=0u)sc_v11_scheduler_internal_cycle(r,1u);
      if(!sc_v11_finish_instruction(r))return 0;
      return r->route_failed?0:1;
    }
  ...
  case 0x0083C2u:
    if(m==1u&&x==0u&&e==0u){ /* 60 ; generated town route */
      sc_v11_scheduler_code_access(r,0x0083C2u,1u);r->open_bus=0x60u;
